...
Azure AI Foundry supports two types of projects: [!INCLUDE [hub-project-name](includes/hub-project-name.md)] and [!INCLUDE [fdp-service-name](includes/fdp-service-name.md)].
...
* A [!INCLUDE [fdp-service-name](includes/fdp-service-name.md)] is built on an Azure AI Foundry resource. This project type does not use a hub. Something here about the advantages of this new project type.

## Which project type do I need?

In general, you should use a [!INCLUDE [fdp-service-name](includes/fdp-service-name.md)].  You only need to use a [!INCLUDE [hub-project-name](includes/hub-project-name.md)] for features that are not available in a [!INCLUDE [fdp-service-name](includes/fdp-service-name.md)]. 
...
| Feature | [!INCLUDE [hub-project-name](includes/hub-project-name.md)] | [!INCLUDE [fdp-service-name](includes/fdp-service-name.md)] |
| --- | --- | --- |
| Prompt flow | Yes | No |
