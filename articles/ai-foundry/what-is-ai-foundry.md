...
Azure AI Foundry supports two types of projects: [!INCLUDE [hub-project-name](includes/hub-project-name.md)] and [!INCLUDE [service-project-name](includes/service-project-name.md)].
