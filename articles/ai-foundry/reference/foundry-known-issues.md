...
| 2005   | Service | DNS cache refresh before end of July 2025 | Due to compliance reasons, the legacy Speech TTS clusters in Asia are removed on July 31, 2025. All traffic is migrated from the old IPs to the new ones. | Some customers are still accessing the old clusters even after DNS redirection has been completed. This indicates that some customers might have persistent local or secondary DNS caches. | July 24, 2025 |
