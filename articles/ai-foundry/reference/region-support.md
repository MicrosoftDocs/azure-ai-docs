...
| Foundry Agent Service         | Agent Service supports the same models as the chat completions API in Azure OpenAI.                                                          | [Agent Service region availability](../default/agents/concepts/limits-quotas-regions.md#azure-openai-models). |
