...
The Black Forest Labs (BFL) collection of image generation models includes FLUX.2 [pro], FLUX.1 Kontext [pro] for in-context generation and editing, and FLUX1.1 [pro] for text-to-image generation.  
