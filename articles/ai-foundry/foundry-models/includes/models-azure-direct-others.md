...
| Model  | Type | Capabilities | Deployment type (region availability) | Project type |
| ------ | ---- | ------------ | ------------------------------------- | ------------ |
| [grok-fast]()  | chat-completion | - **Input:** text ( tokens) <br /> - **Output:** text ( tokens) <br /> - **Languages:** `en` <br />  - **Tool calling:**  <br /> - **Response formats:** text |- Global standard (all regions)  | Foundry, Hub-based |
