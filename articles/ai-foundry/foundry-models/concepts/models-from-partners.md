...
description: Explore the Foundry Models from partners and community and their capabilities.
author: msakande
...
This article lists a selection of Foundry Models from partners and community along with their capabilities, [deployment types, and regions of availability](deployment-types.md), excluding [deprecated and legacy models](../../concepts/model-lifecycle-retirement.md#deprecated). 
