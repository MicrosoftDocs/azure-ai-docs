...
Use the tabs at the top of this page to switch between [Azure OpenAI models](#tabpanel_1_azure-openai) and [other model collections](#tabpanel_1_azure-direct-others) from providers like Cohere, DeepSeek, Meta, Mistral AI, and xAI.
