...
:::image type="content" source="../media/ask-foundry-agent/ask-foundry.png" alt-text="Screenshot shows the Ask AI button in the top right bar of the Azure AI Foundry classic portal.":::
...
- **Documentation**: This documentation includes details about Azure AI Foundry such as Quickstarts, How-tos or reference documentation of the Azure AI Foundry SDK. The agent can help you navigate the documentation, or find answers for you.
- **Model Catalog**: Provide information about specific models in the Azure AI Foundry Model Catalog, including their capabilities and features.
- **Troubleshooting**: Help diagnose and resolve common Azure AI Foundry issues by searching the troubleshooting knowledge base and providing step-by-step solutions.
...
Our portal offers the ability to ask AI to assist you in Azure AI Foundry. To start using AI to ask questions or complete tasks, select its icon located in the top right bar of the [!INCLUDE [classic-link](../includes/classic-link.md)] portal. A chat window opens where you can type your questions and receive answers in real-time. You can also ask the agent to run tasks for you.

:::image type="content" source="../default/media/ask-foundry-agent/ask-ai.png" alt-text="Screenshot shows the Ask AI button in the top right bar of the Azure AI Foundry portal.":::
...
:::image type="content" source="../default/media/ask-foundry-agent/ask-ai-approval-flow.png" alt-text="Screenshot shows the Ask AI chat on the right side of Azure AI Foundry portal. The Ask AI agent is responding a user query by proposing to run an action for the user to approve.":::

The actions are drawn from the tools made available under the [Azure AI Foundry MCP Server](../default/mcp/available-tools.md).
...
The Ask AI experience relies on the [Azure AI Foundry MCP Server](../default/mcp/get-started.md). In doing so, it implements the [same best practices and security guidance](../default/mcp/security-best-practices.md).
