...
1. Set these environment variables to use in your scripts:
    ...
    :::code language="plaintext" source=" source="~/foundry-samples/samples/microsoft/java/mslearn-resources/quickstart/.env.template:::
...
1. Set these environment variables to use in your scripts:
    ...
    :::code language="plaintext" source=" source="~/foundry-samples/samples/microsoft/javascript/mslearn-resources/quickstart/.env.template:::
...
1. Set these environment variables to use in your scripts:
    ...
    :::code language="plaintext" source=" source="~/foundry-samples/samples/microsoft/csharp/mslearn-resources/quickstart/Samples/.env.example:::
