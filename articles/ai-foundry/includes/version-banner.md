...
>
> 🔄 Switch to the [Azure AI Foundry (classic) documentation](?view=foundry-classic&preserve-view=true) if you're using the classic portal, or to see code using GA versions of the client libraries.
>
::: moniker-end
