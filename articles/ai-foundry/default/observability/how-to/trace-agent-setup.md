---
title: How to Set Up Tracing in Azure AI Foundry
ms.service: azure-ai-foundry
titleSuffix: Azure AI Foundry
description: "Enable tracing in Azure AI Foundry to monitor agent performance, debug issues, and analyze runtime behavior using Azure Application Insights and OpenTelemetry."
...
# How to set up tracing in Azure AI Foundry
...
Azure AI Foundry stores traces in [Azure Application Insights](/azure/azure-monitor/app/app-insights-overview) using [OpenTelemetry Semantic Conventions](https://opentelemetry.io/docs/specs/semconv/gen-ai/). To enable tracing and monitoring in your Azure AI Foundry project, create or connect an Application Insights resource in monitor settings. After configuring the connection, tracing is ready to use for your Foundry project.

> [!IMPORTANT]
> Make sure you have the [Log Analytics Reader role](/azure/azure-monitor/logs/manage-access?tabs=portal#log-analytics-reader) assigned in your Application Insights resource. To learn more about assigning roles, see [Assign Azure roles using the Azure portal](/azure/role-based-access-control/role-assignments-portal), and use [Microsoft Entra groups](../../../concepts/rbac-azure-ai-foundry.md#use-microsoft-entra-groups-with-azure-ai-foundry) to manage user access more easily.
...
### Client-side Tracing with Azure AI Foundry SDK
...
After running your agent, you can begin to [view and analyze traces in Azure AI Foundry Portal](#view-traces-in-the-azure-ai-foundry-portal).
...
The toolkit supports AI frameworks such as Azure AI Foundry Agents Service, OpenAI, Anthropic, and LangChain through OpenTelemetry. You can see traces instantly in VS Code without needing cloud access.
...
A **Conversation** is the persistent context of an end-to-end dialogue history between a user and an agent. In the Azure AI Foundry portal, you can view **Conversation** results for your agent run out of the box along with traces on the **Traces** page.
