...
:::code language="python" source="~/foundry-samples-main/samples-v2/microsoft/python/quickstart/quickstart-responses.py":::

 # [C#](#tab/csharp2)

:::code language="csharp" source="~/foundry-samples-main/samples-v2/microsoft/csharp/quickstart/quickstart-responses.cs":::
...
:::code language="console" source="~/foundry-samples-main/samples-v2/microsoft/REST/quickstart/quickstart-responses.sh":::
