...
> - See [administrator control for Web Search](./web-search.md#administrator-control-for-the-web-search-tool) and [manage Grounding with Bing Search](./bing-tools.md#manage-grounding-with-bing-search-and-grounding-with-bing-custom-search) for information about how Azure admins can manage access.

## Determine the best tool for your use cases

If you're just getting started, use [Web Search (preview)](./web-search.md). It requires no extra Azure resources and is the simplest way to add web grounding to your agent.
...
- [Use the Web Search tool (preview)](./web-search.md)
