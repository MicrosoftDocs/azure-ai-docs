...
> [!NOTE]
> There are new ways to add knowledge to your agent. For the latest recommended approach, see [Use knowledge to improve retrieval quality in Foundry Agent Service](./knowledge-retrieval.md).
