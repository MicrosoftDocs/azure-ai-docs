...
> [!NOTE]
> There are new ways to add knowledge to your agent. For the latest recommended approach, see [Use Foundry IQ to improve retrieval quality](./knowledge-retrieval.md).
