...
For declarative agent workflows start by creating a workflow in the [Foundry Portal](https://foundry.microsoft.com/). Then, open it directly from Foundry in VS Code.
