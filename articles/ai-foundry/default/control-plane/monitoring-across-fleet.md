...
You can view aggregated metrics for all agents within a selected project using Foundry. The Overview pane provides insights into fleet health, compliance, and performance trends.
...
You can also view all your assets under a specific project along with top-level metrics from Foundry.
