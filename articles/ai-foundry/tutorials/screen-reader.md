...
Azure AI Foundry has two different project types - see [What is Azure AI Foundry?](../what-is-azure-ai-foundry.md#types-of-projects).  The type appears in the  **Type** column in nthe **All resources** view. In the recent resources picker, the type is in a second line under the project name.
