...
> [!NOTE]
> The information in this article only applies to a **[!INCLUDE [hub](hub-project-name.md)]**. A **[!INCLUDE [fdp](fdp-project-name.md)]** is not supported. For more information, see [Project types](../what-is-azure-ai-foundry.md#project-types).
