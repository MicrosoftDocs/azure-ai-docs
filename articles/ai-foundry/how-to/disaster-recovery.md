...
* **Azure AI Foundry infrastructure**: A Microsoft managed environment for the Azure AI Foundry hub and project. Azure Machine Learning provides the [underlying architecture](Azure AI Foundry architecture doc).
