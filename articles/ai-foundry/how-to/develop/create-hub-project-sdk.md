...
> [!NOTE]
> A hub is used only for a **[!INCLUDE [hub](hub-project-name.md)]**. A **[!INCLUDE [fdp](fdp-project-name.md)]** does not use a hub. For more information, see [Project types](../what-is-azure-ai-foundry.md#project-types).
