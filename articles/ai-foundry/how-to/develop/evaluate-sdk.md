...
To see what each evaluator requires, you can learn more in the [built-in evaluators documents](https://learn.microsoft.com/azure/ai-foundry/concepts/observability#what-are-evaluators).
