...
- **Metric comparison table**: This table presents detailed results for each metric.
    ...
    :::image type="content" source="../default/media/observability/model-benchmarks/benchmark-overview.png" alt-text="Screenshot showing the compare model experience in Microsoft Foundry." lightbox="../default/media/observability/model-benchmarks/benchmark-overview.png":::
