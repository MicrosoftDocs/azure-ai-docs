...
> [!IMPORTANT]
> * Deep Research uses [Grounding with Bing Search](./bing-grounding.md).
...
>    * Your applications must follow the Grounding with Bing Search [use and display requirements](./bing-grounding.md#how-to-display-grounding-with-bing-search-results)
...
1. In the screen that appears, select **Grounding with Bing Search**. 
    ...
    :::image type="content" source="../../media\tools\bing\add-connection.png" alt-text="A screenshot of a project in Azure AI Foundry." lightbox="../../media\tools\bing\add-connection.png":::
