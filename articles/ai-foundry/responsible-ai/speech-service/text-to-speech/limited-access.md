...
<!-- Comment: Retained responsible AI framing here; duplication removed from the avatar section per feedback. -->
...
Custom text to speech avatar is a Limited Access feature available by registration only and only for certain use cases.
<!-- Comment: Replaced repeated responsible-AI framing sentence with concise Limited Access statement per agent feedback. -->

## Registration process 

As Limited Access features, both custom neural voice and custom text to speech avatar require registration. Only customers managed by Microsoft, meaning those who are working directly with Microsoft account teams, are eligible for access. Customers who wish to use either feature are required to register by submitting the [Limited Access registration form](https://aka.ms/customneural). Your use of each feature is limited to the use case(s) that you select and Microsoft approves at the time of registration. Microsoft may require customers to re-verify information submitted for registration.
<!-- Comment: Consolidated duplicated registration process language for both features into a single shared section. -->

Both features are made available to customers under the terms governing their subscription to Microsoft Azure Services (including the [Service Specific Terms](https://go.microsoft.com/fwlink/?linkid=2018760)). Please review these terms carefully as they contain important conditions and obligations governing your use of these features. The following sections summarize key obligations, with feature-specific requirements noted.
<!-- Comment: Consolidated duplicated legal and obligations boilerplate into one introduction. -->

### Obligations for custom neural voice
...
<!-- Comment: Retained feature-specific obligations; removed duplicated introductory boilerplate. -->

### Obligations for custom text to speech avatar
...
<!-- Comment: Retained avatar-specific obligations; removed duplicated legal framing already covered above. -->
