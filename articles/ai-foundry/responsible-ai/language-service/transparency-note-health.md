...
> [!IMPORTANT]
> Text Analytics for health is provided “AS IS” and is not intended for use as a medical device, clinical support, diagnostic tool, or a substitute for professional medical judgment; customers remain solely responsible for its use. The customer must separately license any and all source vocabularies it intends to use under the terms set for that UMLS Metathesaurus License Agreement Appendix or any future equivalent link, and is responsible for ensuring compliance with those license terms, including any geographic or other applicable restrictions.
<!-- Comment: Condensed repeated legal disclaimer language into a single precise sentence while retaining licensing responsibility once. -->
>
> Text Analytics for health now allows extraction of Social Determinants of Health (SDOH) and ethnicity mentions in text. This capability may not cover all potential SDOH and does not derive inferences based on SDOH or ethnicity (for example, substance use information is surfaced, but substance abuse is not inferred). The purpose of the SDOH and ethnicity extraction capability is to help providers improve health outcomes and it should not be used to stigmatize or draw negative inferences about the users or consumers of SDOH data, or patient populations beyond the stated purpose of helping providers improving health outcomes.
<!-- Comment: Removed duplicated human-oversight guidance from this section as it is consolidated later. -->
...
Text Analytics for health is a valuable tool when you manage and extract knowledge from unstructured medical text. However, given the sensitive nature of health-related data, it's important to consider your use cases carefully. In all cases, decisions must be made with human oversight, with mechanisms to review source data and correct errors. Here are some additional considerations when choosing a use case:
<!-- Comment: Consolidated and clarified human-in-the-loop requirement into a single precise sentence. -->
...
This capability doesn’t derive inferences based on SDOH or ethnicity (for example, substance use information is surfaced from the input text, but substance abuse is not inferred based on extracted entities). The purpose of the SDOH and ethnicity extraction capabilities is to help providers improve health outcomes. They should not be used to stigmatize or draw negative inferences about the users or consumers of SDOH data or of patient populations beyond the stated purpose of helping providers improve health outcomes.
<!-- Comment: Removed duplicated human-oversight requirement already stated in the “Considerations when choosing a use case” section. -->
...
* **Human in the loop**: Keep a human in the loop by ensuring that humans oversee and can intervene in decisions based on the model’s output.
<!-- Comment: Condensed repeated human-oversight phrasing into a single clear sentence. -->
