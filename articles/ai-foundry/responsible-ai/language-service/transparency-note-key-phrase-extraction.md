...
A transparency note explains how an AI feature works, its key capabilities and limitations, and the system-level considerations that can affect performance and behavior when it is developed or deployed.
<!-- This sentence replaces a longer, repetitive description to provide a concise, factual definition of a transparency note. -->

Microsoft’s transparency notes support the company’s Responsible AI principles.
<!-- This sentence replaces broader marketing-oriented framing with a concise factual pointer. -->
