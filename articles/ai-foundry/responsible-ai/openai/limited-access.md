...
Azure Direct Models and Azure OpenAI Service are made available to customers under the terms governing their subscription to Microsoft Azure Services, including the [Product Terms](https://www.microsoft.com/licensing/terms/welcome/welcomepage), the Universal License Terms applicable to Microsoft Generative AI Services, and the applicable product offering terms. Please review these terms carefully as they contain important conditions and obligations governing your use.
<!-- Consolidated two duplicated policy paragraphs describing service availability and removed repetitive boilerplate language per agent feedback. -->
