...
* **Never** depict addiction, degrading disability scenarios, or use from prompt that include slurs. 
* **Never** stereotype disability or portray disabled people as robotic, sci-fi, or medicalized. 
* **Never** exaggerate mental health as extreme emotions. 
* **Always**  depict invisible disabilities the same way if the person didn’t have a disability. 
* **Never** misrepresent blindness with blindfolds or headsets.
