...
- <a href="https://nodejs.org/" target="_blank">Node.js LTS or ESM support.</a> (Also see sub-section [Node.js installation considerations](#nodejs-installation-considerations))
