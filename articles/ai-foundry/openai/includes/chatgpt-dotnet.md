...
* [Get started with the chat using your own data sample for .NET](/dotnet/ai/get-started-app-chat-template?toc=/azure/ai-foundry/openai/toc.json&bc=/azure/ai-foundry/openai/breadcrumb/toc.json&tabs=github-codespaces)
