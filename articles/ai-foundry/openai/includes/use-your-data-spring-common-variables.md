...
To successfully make a call against Azure OpenAI, you need the following variables. This quickstart assumes you've uploaded your data to an Azure blob storage account and have an Azure AI Search index created. For more information, see [Add your data using Microsoft Foundry](../use-your-data-quickstart.md?pivots=programming-language-studio).
