...
> [!NOTE]
> Batch file limits do not apply to output files (for example, `result.jsonl`, and `error.jsonl`). To remove batch input file limits use [Batch with Azure Blob Storage](../../openai/how-to/batch-blob-storage.md).
