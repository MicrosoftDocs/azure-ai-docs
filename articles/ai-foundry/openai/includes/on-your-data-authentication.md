...
:::image type="content" source="../media/use-your-data/data-connection-authentication.png" alt-text="A screenshot showing the managed identity option in Microsoft Foundry portal." lightbox="../media/use-your-data/data-connection-authentication.png":::
