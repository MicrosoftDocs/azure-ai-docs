...
description: Learn how the safety evaluation works for Azure AI Foundry fine-tuning.
manager: nitinme
...
- Explore the fine-tuning capabilities in the [Azure AI Foundry fine-tuning tutorial](../tutorials/fine-tune.md).
- Review fine-tuning [model regional availability](../concepts/models.md#fine-tuning-models)
- Learn more about [Azure AI Foundry quotas](../quotas-limits.md)
