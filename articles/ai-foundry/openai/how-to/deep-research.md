...
To start, call the **Responses API** with the model set to `o3-deep-research`. Include at least one data source: web search or a remote MCP server. Optionally, add the code interpreter tool for advanced analysis.
