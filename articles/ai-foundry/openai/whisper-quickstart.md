...
> [!NOTE]
> For information about other audio models that you can use with Azure OpenAI, see [Audio models](../foundry-models/concepts/models-sold-directly-by-azure.md?tabs=standard-audio#standard-deployment-regional-models-by-endpoint).
