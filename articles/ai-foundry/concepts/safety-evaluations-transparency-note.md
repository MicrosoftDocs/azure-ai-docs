...
A Transparency Note explains the intended purpose, capabilities, and limitations of an AI feature so you can make informed decisions about how to use it responsibly. For Microsoft Foundry safety evaluations, this note describes what the system evaluates, the constraints of its coverage and methodology, and where human judgment and additional testing are required.
<!-- Edited to remove low-signal boilerplate and replace it with concise, factual description of purpose and constraints. -->
...
- **Protected material content (for text and images)** refers to copyrighted or otherwise protected content that might be reproduced in model outputs. This includes known textual content (for example, song lyrics, articles, recipes, and selected web content) and protected visual content (for example, logos, brands, artworks, or fictional characters). Detection helps organizations reduce the risk of intellectual property infringement and preserve content originality.  
<!-- Edited to collapse duplicated text and image definitions into a single, clearly scoped entry. -->
...
- **Evaluating your generative AI application pre-deployment**: Using the evaluation wizard in the Foundry portal or the Azure AI Python SDK, safety evaluations can assess in an automated way to evaluate potential content or security risks.
...
- **Communicating content and security risks to stakeholders**: Using the Foundry portal, you can share access to your Foundry project with safety evaluations results with auditors or compliance stakeholders.
...
- **Safety evaluations should include human-in-the-loop**: Using automated evaluations like Foundry safety evaluations should include human reviewers such as domain experts to assess whether your generative AI application has been tested thoroughly prior to deployment to end users.
