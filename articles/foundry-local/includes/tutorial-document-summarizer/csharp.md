...
:::code language="csharp" source="~/foundry-local-samples-main/samples/cs/tutorial-document-summarizer/Program.cs" id="file_reading":::
...
:::code language="csharp" source="~/foundry-local-samples-main/samples/cs/tutorial-document-summarizer/Program.cs" id="summarization":::
...
:::code language="csharp" source="~/foundry-local-samples-main/samples/cs/tutorial-document-summarizer/Program.cs" id="complete_code":::
