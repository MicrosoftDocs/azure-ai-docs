...
1. Open `Program.cs` and add the following tool definitions:
    ...
    :::code language="csharp" source="~/foundry-local-samples-main/samples/cs/tutorial-tool-calling/Program.cs" id="tool_definitions":::
...
:::code language="csharp" source="~/foundry-local-samples-main/samples/cs/tutorial-tool-calling/Program.cs" id="init":::
...
:::code language="csharp" source="~/foundry-local-samples-main/samples/cs/tutorial-tool-calling/Program.cs" id="tool_loop":::
...
:::code language="csharp" source="~/foundry-local-samples-main/samples/cs/tutorial-tool-calling/Program.cs" id="complete_code":::
