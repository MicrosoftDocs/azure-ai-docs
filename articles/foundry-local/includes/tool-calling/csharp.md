...
:::code language="csharp" source="~/foundry-local-samples-main/samples/cs/tool-calling-foundry-local-sdk/Program.cs" id="complete_code":::
...
:::code language="csharp" source="~/foundry-local-samples-main/samples/cs/tool-calling-foundry-local-web-server/Program.cs" id="complete_code":::
