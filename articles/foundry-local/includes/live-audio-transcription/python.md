...
cd Foundry-Local/samples/python/live-audio-transcription
```
...
:::code language="python" source="~/foundry-local-main/samples/python/live-audio-transcription/src/app.py":::
