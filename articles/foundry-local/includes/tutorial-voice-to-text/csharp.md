...
- Open `Program.cs` and replace its contents with the following code to initialize the SDK, load the speech model, and transcribe an audio file:
    ...
    :::code language="csharp" source="~/foundry-local-samples-main/samples/cs/tutorial-voice-to-text/Program.cs" id="transcription":::
...
:::code language="csharp" source="~/foundry-local-samples-main/samples/cs/tutorial-voice-to-text/Program.cs" id="summarization":::
...
:::code language="csharp" source="~/foundry-local-samples-main/samples/cs/tutorial-voice-to-text/Program.cs" id="complete_code":::
