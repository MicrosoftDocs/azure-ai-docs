...
- Open `Program.cs` and replace its contents with the following code to initialize the SDK and select a model:
    ...
    :::code language="csharp" source="~/foundry-local-samples-main/samples/cs/tutorial-chat-assistant/Program.cs" id="init":::
...
:::code language="csharp" source="~/foundry-local-samples-main/samples/cs/tutorial-chat-assistant/Program.cs" id="system_prompt":::
...
:::code language="csharp" source="~/foundry-local-samples-main/samples/cs/tutorial-chat-assistant/Program.cs" id="conversation_loop":::
...
:::code language="csharp" source="~/foundry-local-samples-main/samples/cs/tutorial-chat-assistant/Program.cs" id="streaming":::
...
:::code language="csharp" source="~/foundry-local-samples-main/samples/cs/tutorial-chat-assistant/Program.cs" id="complete_code":::
