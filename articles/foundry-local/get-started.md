---
title: "Get started with Foundry Local (temp)"
titleSuffix: Foundry Local
description: "Learn how to install, configure, and run your first AI model with Foundry Local (temp)"
ms.date: 01/06/2026
...
# Get started with Foundry Local (temp)
