...
- **Model acquisition**: Seamless download from Foundry Model Catalog with versioning, updates, and automatic hardware-optimized model selection with fallback support.
- **Efficient runtime**: Adds <20MB to app size, runs on devices from mobile phones to desktops.
