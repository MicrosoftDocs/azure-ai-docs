---
title: "Optimize Cost and Performance in Microsoft Foundry (temp)"
description: "Learn how to use the Ask AI agent to analyze and optimize model cost and performance directly from Microsoft Foundry. (temp)"
...
<!-- CLASSIC-ONLY: - An evaluation dataset configured for your project. To set one up, see [Evaluate your generative AI application locally with the Azure AI Evaluation SDK](../how-to/develop/evaluate-sdk.md). -->
...
<!-- CLASSIC-ONLY: - [Evaluate your generative AI application locally with the Azure AI Evaluation SDK](../how-to/develop/evaluate-sdk.md) -->
