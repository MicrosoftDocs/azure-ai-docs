...
<!-- CLASSIC-ONLY: Send traces to the Application Insights resource of your project by using its instrumentation key. To get the instrumentation key associated with your project, follow the instructions at [Enable tracing in your project](../how-to/develop/trace-application.md#enable-tracing-in-your-project). -->
