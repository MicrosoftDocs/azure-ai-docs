...
Send traces to the Application Insights resource of your project by using its instrumentation key. To get the instrumentation key associated with your project, follow the instructions at [Enable tracing in your project](/azure/foundry-classic/how-to/develop/trace-application#enable-tracing-in-your-project).
