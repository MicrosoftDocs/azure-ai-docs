...
<!-- CLASSIC-ONLY: For a list of limits for vector search (such as maximum allowable file sizes), see the [quotas and limits](../../agents/quotas-limits.md) article. -->
...
<!-- CLASSIC-ONLY: For file size and token limits, see [quotas and limits](../../agents/quotas-limits.md). -->
...
<!-- CLASSIC-ONLY: - File size and token limits vary by feature. See [Quotas and limits](../../agents/quotas-limits.md). -->
...
<!-- CLASSIC-ONLY: - **Uploads or ingestion fail**: Check file size and token limits in [Quotas and limits](../../agents/quotas-limits.md). -->
