...
If you use the Foundry SDK, you need to perform these steps independently. For more information, see [Enable tracing in your project](/azure/foundry-classic/how-to/develop/trace-application#enable-tracing-in-your-project).
...
For more information about evaluating agents, see [Evaluate your AI agents](/azure/foundry-classic/how-to/develop/agent-evaluate-sdk) and [Agent evaluators](../../concepts/evaluation-evaluators/agent-evaluators.md).
