...
1. **Optimize hosted agents (preview)**: Automatically improve your hosted agent's instructions and discover skills using the [agent optimization service](agent-optimization-overview.md).
