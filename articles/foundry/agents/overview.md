...
ms.date: 01/21/2026
ms.custom:
  - azure-ai-agents, pilot-ai-workflow-jan-2026
  - classic-and-new
...
<!-- CLASSIC-ONLY: - A deployed model that your agent can use. Model and region availability can vary; see [models that inform agents](concepts\model-region-support.md). -->
...
<!-- CLASSIC-ONLY: - For service limits, quotas, and throttling considerations, see [Quotas and limits for Agent Service](quotas-limits.md). -->
<!-- CLASSIC-ONLY: - For model and region support, see [models that inform agents](concepts\model-region-support.md). -->
...
<!-- CLASSIC-ONLY: - **Safety controls**: Use integrated [content filters](../openai/how-to/content-filters.md) to help reduce unsafe outputs and mitigate prompt injection risks, including cross-prompt injection attacks (XPIA). -->
...
<!-- CLASSIC-ONLY: - **Model isn't available in your region**: See [models that inform agents](concepts\model-region-support.md). -->
<!-- CLASSIC-ONLY: - **Requests are throttled or fail due to quota**: See [Quotas and limits for Agent Service](quotas-limits.md). -->
...
<!-- CLASSIC-ONLY: - **You need to debug tool calls or agent behavior**: Start with [trace agents with the SDK](../how-to/develop/trace-agents-sdk.md) and [metrics](how-to/metrics.md). -->

## Related content

<!-- CLASSIC-ONLY: - [Quickstart: Create your first agent](./quickstart.md) -->
<!-- CLASSIC-ONLY: - [Models that inform agents](concepts/model-region-support.md) -->
- [Microsoft Foundry SDKs](../how-to/develop/sdk-overview.md)
<!-- CLASSIC-ONLY: - [Content filters for safety](../openai/how-to/content-filters.md) -->
<!-- CLASSIC-ONLY: - [Trace agents with the SDK](../how-to/develop/trace-agents-sdk.md) -->
- [Use your own resources](how-to/use-your-own-resources.md)
<!-- CLASSIC-ONLY: - [Quotas and limits for Agent Service](quotas-limits.md) -->
