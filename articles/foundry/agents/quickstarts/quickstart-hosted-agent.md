...
<!-- CLASSIC-ONLY:     * This example uses `gpt-5`, you may need to use another model (such as `gpt-4.1`) depending on your [quotas and limits](../../agents/quotas-limits.md#quotas-and-limits-for-models). -->
