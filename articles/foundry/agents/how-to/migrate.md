---
title: "How to migrate to the new agent service (temp)"
description: "Learn how to migrate to the latest agents API in the Microsoft Foundry. (temp)"
author: aahill
ms.author: aahi
manager: nitinme
ms.date: 12/09/2025
...
# Upgrading to the new agents developer experience (temp) 
