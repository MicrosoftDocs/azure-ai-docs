---
title: "Connect OpenAPI tools to Microsoft Foundry agents (temp)"
description: "Connect OpenAPI 3.0 tools to Microsoft Foundry agents using API key, managed identity, or anonymous authentication. Integrate external APIs with your AI agents today. (temp)"
...
# Connect agents to OpenAPI tools (temp)
