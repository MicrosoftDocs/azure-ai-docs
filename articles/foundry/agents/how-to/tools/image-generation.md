...
Content filtering can block image generation if the service detects unsafe content in your prompt. For more information, see [Content filter](/azure/foundry-classic/foundry-models/concepts/content-filter).
...
| Prompt doesn't produce an image | Content filtering blocked the request | Check content filtering logs. See [Content filter](/azure/foundry-classic/foundry-models/concepts/content-filter) for guidelines on acceptable prompts. |
...
- [Content filter](/azure/foundry-classic/foundry-models/concepts/content-filter)
