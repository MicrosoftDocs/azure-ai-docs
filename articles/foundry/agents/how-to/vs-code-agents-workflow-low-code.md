---
title: "Work with Declarative (Low-code) Agent workflows in Visual Studio Code (temp)"
description: "Use this article to learn how to use low-code declarative workflows with Foundry Agent Service directly in VS Code. (temp)"
manager: mcleans
...
# Work with Declarative (Low-code) Agent workflows in Visual Studio Code (preview) (temp)
...
/azure/ai-foundry/how-to/develop/vs-code-agents?tabs=windows-powershell&pivots=python) by using this Visual Studio Code (VS Code) extension, you can add workflows to your agent.
