...
|--------|----------------|--------------|
| Responses | `https://{account}.../projects/{project}/applications/{app}/protocols/openai` | `https://{account}.../projects/{project}/agents/{agent}/endpoint/protocols/openai/responses?api-version=v1` |
