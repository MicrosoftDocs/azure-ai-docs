---
title: "Use your own resources in the Foundry Agent Service (temp)"
description: "Learn how to use resources that you already have with the Foundry Agent Service. (temp)" 
...
To use the [Grounding with Bing Search tool](../../agents/how-to/tools/bing-tools.md) the following provider must be registered: `Microsoft.Bing`
...
* Learn about the different [tools](../../agents/concepts/tool-catalog.md) agents can use. 
