---
title: "Work with Foundry Classic agents and MCP server tools in Visual Studio Code (temp)"
description: "Add Model Context Protocol (MCP) server tools to your Foundry Classic agents by using the Microsoft Foundry for Visual Studio Code extension. (temp)"
manager: mcleans
...
<!-- CLASSIC-ONLY: After you create your agent, you can add tools to it, including MCP tools. For more information about available tools, see [Tools for agents](../../agents/how-to/tools-classic/overview.md). -->
...
<!-- > [!WARNING] (callout removed - content was version-specific) -->
<!-- CLASSIC-ONLY: > The remote MCP servers that you use with the MCP tool in this article are not from Microsoft. Microsoft doesn't test or verify these servers. For details, see [Considerations for using non-Microsoft services and servers](../../agents/how-to/tools-classic/model-context-protocol.md#considerations-for-using-non-microsoft-services-and-servers). -->
...
<!-- CLASSIC-ONLY: - [Model Context Protocol (MCP) tool](../../agents/how-to/tools-classic/model-context-protocol.md) -->
<!-- CLASSIC-ONLY: - [Tools for agents](../../agents/how-to/tools-classic/overview.md) -->
...
<!-- CLASSIC-ONLY: - [File search tool](../../agents/how-to/tools-classic/file-search.md) -->
<!-- CLASSIC-ONLY: - [Code interpreter tool](../../agents/how-to/tools-classic/code-interpreter.md) -->
