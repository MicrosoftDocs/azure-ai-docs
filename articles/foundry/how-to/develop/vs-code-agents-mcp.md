---
title: "Work with Foundry Agent Service and MCP Server Tools in Visual Studio Code (temp)"
description: "Use this article to learn how to use MCP server tools with Foundry Agent Service directly in VS Code. (temp)"
manager: mcleans
...
# Work with Foundry Agent Service and MCP server tools in Visual Studio Code (preview) (temp)
