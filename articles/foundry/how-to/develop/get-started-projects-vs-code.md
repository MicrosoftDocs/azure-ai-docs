---
title: "Work with the Microsoft Foundry for Visual Studio Code extension (temp)"
description: "Use this article to learn how to create projects and deploy Large Language Models using Microsoft Foundry capabilities directly in VS Code. (temp)"
manager: mcleans
...
# Work with the Microsoft Foundry for Visual Studio Code extension (Preview) (temp)
...
<!-- CLASSIC-ONLY: - Your subscription needs to be below your [quota limit](../quota.md) to [deploy a new model in this quickstart](#deploy-a-model-from-the-model-catalog). Otherwise you already need to have a [deployed chat model](../../foundry-models/how-to/deploy-foundry-models.md). -->
