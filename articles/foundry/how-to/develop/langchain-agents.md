...
:::image type="content" source="../media/langchain-azure-ai-agents/agent-no-tools.png" alt-text="Diagram of the agent graph for an agent without tools.":::
...
:::image type="content" source="../media/langchain-azure-ai-agents/agent-codegen-tool.png" alt-text="The image generated by the `CodeInterpreterTool`.":::
...
:::image type="content" source="../media/langchain-azure-ai-agents/agent-imagegen-tool.png" alt-text="The image generated by the `ImageGenTool`.":::
...
:::image type="content" source="../media/langchain-azure-ai-agents/agent-approval.png" alt-text="Diagram of the agent graph for an agent with approval flows implemented.":::
