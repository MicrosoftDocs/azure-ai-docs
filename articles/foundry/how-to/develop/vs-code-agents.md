---
title: "Create and manage Foundry Classic agents in Visual Studio Code (temp)"
description: "Create, configure, test, and deploy Foundry Classic agents directly in Visual Studio Code by using the Foundry Agent Service extension and designer. (temp)"
manager: mcleans
...
# Create and manage Foundry Classic agents in Visual Studio Code (preview) (temp)
...
<!-- CLASSIC-ONLY: - [Grounding with Bing search](../../agents/how-to/tools-classic/bing-grounding.md) -->
<!-- CLASSIC-ONLY: - [File search](../../agents/how-to/tools-classic/file-search.md) -->
<!-- CLASSIC-ONLY: - [Code interpreter](../../agents/how-to/tools-classic/code-interpreter.md) -->
<!-- CLASSIC-ONLY: - [OpenAPI specified tools](../../agents/how-to/tools-classic/openapi-spec.md) -->
<!-- CLASSIC-ONLY: - [Model Context Protocol (MCP)](../../agents/how-to/tools-classic/model-context-protocol.md) -->
...
<!-- CLASSIC-ONLY: - [Agent tools overview](../../agents/how-to/tools-classic/overview.md) for details on file search, code interpreter, and other available tools. -->
