...
:::image type="content" source="../media/langchain-azure-ai-agents/react-agent-codegen-tool.png" alt-text="The image generated by the `CodeInterpreterTool`.":::
...
:::image type="content" source="../media/langchain-azure-ai-agents/react-agent-imagegen-tool.png" alt-text="The image generated by the `ImageGenTool`.":::
...
5. Select **View Traces with Agent Runs**. The side panel shows all the traces generated by agent runs.
	...
	:::image type="content" source="../media/langchain-azure-ai-agents/langchain-azure-ai-azmon-runs.png" alt-text="Screenshot showing the Agents (Preview) section in Azure Monitor displaying multiple runs.":::

6. Select one of the traces. You should see the details.

	:::image type="content" source="../media/langchain-azure-ai-agents/langchain-azure-ai-azmon-trace.png" alt-text="Screenshot showing the trace details of the selected run.":::
