...
| LangGraph hosting | `langchain_azure_ai.agents.hosting` | Host compiled LangGraph agents on Foundry Agent Service with Responses or Invocations protocols. [See detailed examples](langchain-hosting.md). |
...
- [Host LangGraph agents as Foundry hosted agents](langchain-hosting.md)
