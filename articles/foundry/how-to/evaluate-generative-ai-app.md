...
> [!TIP]
> For programmatic evaluation workflows, use the Azure AI Evaluation SDK. See [How to run batch evaluation with the SDK](../observability/how-to/cloud-evaluation.md).
...
- [How to run batch evaluation with the SDK](../observability/how-to/cloud-evaluation.md)
