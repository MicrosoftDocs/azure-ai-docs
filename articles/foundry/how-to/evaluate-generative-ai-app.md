...
- A Microsoft Foundry project. [Create a project](../quickstarts/create-project.md) if you don't have one.
...
3. **Select your file**: Choose a dataset containing scenario descriptions. Each row in your dataset describes a scenario that will be used to generate a simulated conversation.
   ...
   :::image type="content" source="../media/evaluations/simulation-dataset-preview.png" alt-text="Screenshot showing the dataset preview in the simulation dialog.":::
