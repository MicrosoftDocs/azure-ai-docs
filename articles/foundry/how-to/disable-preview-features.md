---
title: "Disable preview features in Microsoft Foundry"
description: "Learn how to disable preview features in Microsoft Foundry by using Azure tags to hide portal surfaces or custom RBAC roles to block specific operations."
author: sdgilley
ms.author: sgilley
...
- Azure CLI installed and signed in, if you create roles from the command line. For more information, see [Install the Azure CLI](/cli/azure/install-azure-cli).
- Access to [Azure portal](https://portal.azure.com).

[!INCLUDE [disable-preview-tag-procedure](../includes/disable-preview-tag-procedure.md)]
...
Because you can't modify built-in roles, you create a [custom role](/azure/role-based-access-control/custom-roles) that uses `notDataActions` (or `notActions` for control plane features like Tracing) to exclude the permissions you want to block.
...
- [Authentication and authorization in Microsoft Foundry](../concepts/authentication-authorization-foundry.md)
