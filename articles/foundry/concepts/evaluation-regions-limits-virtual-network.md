---
title: "Rate limits, region, and virtual network support for evaluation (temp)"
description: "Learn about region availability, rate limits, and virtual network support for evaluation in Microsoft Foundry. (temp)"
author: lgayhardt
ms.author: lagayhar
...
# Rate limits, region, and virtual network support for evaluation (temp)
