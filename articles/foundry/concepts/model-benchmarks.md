...
Model leaderboards (preview) in Foundry portal help you compare models in the Foundry [model catalog](/azure/foundry-classic/concepts/foundry-models-overview) using industry-standard model benchmarks.
...
Performance metrics are aggregated over 14 days using 24 trials per day, with two requests per trial sent at one-hour intervals. Unless otherwise noted, the following default parameters apply to both [serverless API deployments](/azure/foundry-classic/concepts/foundry-models-overview) and [Azure OpenAI](/azure/ai-foundry/openai/overview):

| Parameter | Value | Applicable for |
|--|--|--|
| Region | East US/East US2 | [serverless API deployments](/azure/foundry-classic/concepts/foundry-models-overview) and [Azure OpenAI](/azure/ai-foundry/openai/overview) |
...
| Streaming | True | Applies to serverless API deployments and Azure OpenAI. For models deployed via [managed compute](/azure/foundry-classic/concepts/foundry-models-overview), or for endpoints when streaming isn't supported TTFT is represented as P50 of latency metric. |
...
- [Model catalog and collections in Foundry portal](/azure/foundry-classic/concepts/foundry-models-overview)
- [Evaluate your generative AI apps](../how-to/evaluate-generative-ai-app.md)
- [Deploy models with serverless API](/azure/foundry-classic/how-to/deploy-models-serverless)