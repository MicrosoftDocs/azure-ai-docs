...
| [Voice-based prompt agents](../agents/quickstarts/prompt-voice-agent.md) | Prompt agents that speak and listen in real time, with managed voice orchestration. | Use when you want a spoken experience without hosting a speech pipeline. If you only need text responses, use prompt agents. | Agent developer |
