---
title: "Quickstart: Generate images with Azure OpenAI in Microsoft Foundry Models (temp)"
description: "Learn how to get started generating images with Azure OpenAI by using the Python SDK, the REST APIs, or Microsoft Foundry portal. (temp)"
manager: nitinme
ms.service: azure-ai-foundry
ms.subservice: azure-ai-foundry-openai
ms.custom:
  - devx-track-python, devx-track-dotnet, devx-track-extended-java, devx-track-go, devx-track-js, devx-track-ts, dev-focus
  - classic-and-new
ms.topic: quickstart
...
# Quickstart: Generate images with Azure OpenAI in Microsoft Foundry Models (temp)
