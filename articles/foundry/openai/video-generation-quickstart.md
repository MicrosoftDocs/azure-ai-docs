---
title: "Quickstart: Generate video with Sora (temp)"
description: "Learn how to get started generating video clips with Azure OpenAI. (temp)"
manager: nitinme
...
# Quickstart: Generate a video with Sora (preview) (temp)
