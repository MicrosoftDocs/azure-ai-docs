---
title: "Azure OpenAI in Microsoft Foundry Models Quotas and Limits (temp)"
description: "This article features detailed descriptions and best practices on the quotas and limits for Azure OpenAI. (temp)"
author: mrbullwinkle
ms.author: mbullwin
manager: nitinme
ms.date: 02/17/2026
...
# Azure OpenAI in Microsoft Foundry Models quotas and limits (temp)
...
<!-- CLASSIC-ONLY: > Currently, both the Foundry portal and the capacity API return quota/capacity information for models that are [retired](./concepts/model-retirements.md) and no longer available. -->
...
<!-- CLASSIC-ONLY: - Explore how to [manage quota](./how-to/quota.md) for your Azure OpenAI deployments. -->
