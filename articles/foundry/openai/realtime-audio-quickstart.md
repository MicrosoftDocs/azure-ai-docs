---
title: "How to use GPT Realtime API for speech and audio with Azure OpenAI in Microsoft Foundry Models (temp)"
description: "Learn how to use GPT Realtime API for speech and audio with Azure OpenAI. (temp)"
manager: nitinme
...
# GPT Realtime API for speech and audio (temp)
