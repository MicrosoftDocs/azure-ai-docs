...
<!-- CLASSIC-ONLY: See [Model versions](../concepts/model-versions.md) to learn about how Azure OpenAI handles model version upgrades. See [Working with models](../how-to/working-with-models.md) to learn how to view and configure the model version settings of your GPT-4 deployments. -->
...
<!-- CLASSIC-ONLY: - [Model retirement and deprecation](../concepts/model-retirements.md) -->
