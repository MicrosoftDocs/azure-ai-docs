...
| --- | :--- | :--- | :--- | :---: |
| `gpt-chat-latest` (2026-08-06)<br>**Preview** | - Chat Completions API. <br> - [Responses API](../how-to/responses.md). <br> - Structured outputs <br> - Functions, tools, and tool calling. | 400,000<br><br>Input: 272,000<br>Output: 128,000 | 128,000 | February 2026 |
| `gpt-chat-latest` (2026-06-24)<br>**Preview** | - Chat Completions API. <br> - [Responses API](../how-to/responses.md). <br> - Structured outputs <br> - Functions, tools, and tool calling. | 128,000 <br><br>Input: 111,616 <br> Output: 16,384 | 16,384 | August 2025 |
| `gpt-chat-latest` (2026-05-28)<br>**Preview** | - Chat Completions API. <br> - [Responses API](../how-to/responses.md). <br> - Structured outputs <br> - Functions, tools, and tool calling. | 128,000 <br><br>Input: 111,616 <br> Output: 16,384 | 16,384 | August 2025 |
| `gpt-chat-latest` (2026-05-05)<br>**Preview** | - Chat Completions API. <br> - [Responses API](../how-to/responses.md). <br> - Structured outputs <br> - Functions, tools, and tool calling. | 128,000 <br><br>Input: 111,616 <br> Output: 16,384 | 16,384 | August 2025 |
...
<sup>1</sup> The provisioned version of `gpt-4` version `turbo-2024-04-09` is currently limited to text only. For more information on provisioned deployments, see [Provisioned guidance](../concepts/provisioned-throughput.md).
...
For the latest information on model retirements, refer to the [Model retirement schedule](../concepts/model-retirement-schedule.md).
