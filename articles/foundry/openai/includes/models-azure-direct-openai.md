...
> [!NOTE]
> Some [quota tiers](../quotas-limits.md) require quota requests for `gpt-5.6-sol` and `gpt-5.6-terra` to deploy these models. Tier 5 and Tier 6 subscriptions have quota by default.
