...
| Maximum input file size - [Bring your own storage (BYOS)](/azure/foundry-classic/openai/how-to/batch-blob-storage) | 1 GB |
| Maximum requests per file | 100,000 |

> [!NOTE]
> Batch file limits don't apply to output files (for example, `result.jsonl`, and `error.jsonl`). To remove batch input file limits, use [Batch with Azure Blob Storage](/azure/foundry-classic/openai/how-to/batch-blob-storage).
