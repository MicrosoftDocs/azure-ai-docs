...
For design guidance, see [System message design](../concepts/advanced-prompt-engineering.md) and [Safety system messages](../concepts/system-message.md).
...
If the model refuses too often or allows harmful content, adjust your safety system message and retest. See [Safety system messages](../concepts/system-message.md) for iteration strategies.
...
| Unsafe content still appears. | The message is too narrow, or user prompts override behavior. | Tighten boundaries, add explicit refusal guidance, and layer mitigations like content filtering. See [Content filtering overview](../../../foundry-classic/foundry-models/concepts/content-filter.md). |
| Responses are inconsistent across runs. | Conflicting instructions or unclear priorities. | Remove conflicts, prioritize rules, and keep the message shorter. See [Common pitfalls](../concepts/advanced-prompt-engineering.md#common-pitfalls). |
