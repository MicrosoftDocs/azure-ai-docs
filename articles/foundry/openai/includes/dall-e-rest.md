...
- Then, you need to deploy a `gpt-image-1`-series or `dalle3` model with your Azure resource. For more information, see [Create a resource and deploy a model with Azure OpenAI](/azure/foundry-classic/openai/how-to/create-resource).
...
The Image APIs come with a content moderation filter. If the service recognizes your prompt as harmful content, it doesn't generate an image. For more information, see [Content filtering](/azure/foundry-classic/foundry-models/concepts/content-filter). For examples of error responses, see the [Image generation how-to guide](../how-to/dall-e.md).
