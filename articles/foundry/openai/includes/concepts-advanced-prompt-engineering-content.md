...
If you want broader prompt guidance (few-shot examples, ordering, and token efficiency), see [Prompt engineering techniques](../concepts/prompt-engineering.md).
...
If you’re tuning prompts as part of an evaluation workflow, you can also use the broader guidance in [Prompt engineering techniques](../concepts/prompt-engineering.md).
