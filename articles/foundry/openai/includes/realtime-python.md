...
<!-- CLASSIC-ONLY: - Then, you need to deploy a `gpt-realtime`, `gpt-realtime-mini`, or `gpt-realtime-mini-2025-12-15` model with your Azure OpenAI resource. For more information, see [Create a resource and deploy a model with Azure OpenAI](../how-to/create-resource.md). -->
