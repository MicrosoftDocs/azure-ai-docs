...
While Microsoft has conducted red teaming exercises and implemented safety systems (including [content filters](../../../foundry-classic/openai/how-to/content-filters.md) and other [mitigation strategies](../concepts/prompt-engineering.md)) for its Azure OpenAI in Microsoft Foundry Models (see this [Overview of responsible AI practices](/azure/ai-foundry/responsible-ai/openai/overview)), the context of each LLM application will be unique and you also should conduct red teaming to:
...
1. Provides a link to the raw data.
1. Previews the testing plan for the upcoming rounds.
1. Acknowledges red teamers.
1. Provides any other relevant information.
...
- Use [prompt engineering](../concepts/prompt-engineering.md) techniques to reduce risk, then retest to validate improvements.
