...
Endpoints and API keys for your resources can be retrieved from the [Azure portal](https://portal.azure.com) or the [!INCLUDE [foundry-link](../../../includes/foundry-link.md)] portal:

- Sign in to [Azure portal](https://portal.azure.com) > select your resource > **Resource Management** > **Keys and Endpoint**.
- Sign in to [!INCLUDE [foundry-link](../../../includes/foundry-link.md)] portal > select your resource.
