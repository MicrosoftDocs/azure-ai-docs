...
You need to retrieve the following information to authenticate your application with your Azure OpenAI resource. This quickstart assumes you've uploaded your data to an Azure blob storage account and have an Azure AI Search index created. See [Add your data using Microsoft Foundry portal](../../quickstarts/get-started-code.md?pivots=programming-language-studio).
