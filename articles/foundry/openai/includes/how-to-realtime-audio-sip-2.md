...
- [Use the Realtime API via WebRTC](../how-to/realtime-audio-webrtc.md) for browser-based applications
- [Use the Realtime API via WebSocket](../how-to/realtime-audio-websockets.md) for server-to-server scenarios
- [Azure OpenAI webhooks](../how-to/webhooks.md) for webhook configuration details
