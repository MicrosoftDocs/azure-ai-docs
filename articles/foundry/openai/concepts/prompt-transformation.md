---
title: "Azure OpenAI prompt transformation concepts (temp)"
description: "Learn about the prompt transformation feature in Azure OpenAI DALL-E 3, how it works, and why it's necessary. (temp)"
...
<!-- CLASSIC-ONLY: For more information about content filtering, see [Content filtering](../../foundry-models/concepts/content-filter.md). -->
...
<!-- CLASSIC-ONLY: Default prompt transformation includes safety-oriented guidance intended to reduce requests for disallowed content, such as copyrighted or trademarked characters, public figures, and content in categories such as sexual, hate and unfairness, violence, and self-harm. For enforcement behavior details, see [Content filtering](../../foundry-models/concepts/content-filter.md). -->
