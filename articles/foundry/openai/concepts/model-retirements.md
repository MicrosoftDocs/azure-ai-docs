---
title: "Azure OpenAI in Microsoft Foundry Model Retirements (temp)"
description: "Learn about model deprecations and retirements in Azure OpenAI. (temp)"
...
For information on the model upgrade process, see [How to upgrade to a new model or version](/azure/foundry-classic/openai/concepts/model-versions).
