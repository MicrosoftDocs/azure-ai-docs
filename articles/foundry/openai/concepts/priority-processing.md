...
[!INCLUDE [standard-global-priority-processing](../includes/model-matrix/standard-global-priority-processing.md)]

# [Data Zone standard](#tab/datazone-standard)

### Data zone standard model availability

[!INCLUDE [datazone-standard-priority-processing](../includes/model-matrix/datazone-standard-priority-processing.md)]
