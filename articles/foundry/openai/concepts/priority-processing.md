...
<!-- CLASSIC-ONLY: For more information about monitoring your deployments, see [Monitor Azure OpenAI](../how-to/monitor-openai.md). -->
...
<!-- CLASSIC-ONLY: - [Monitoring Azure OpenAI](../how-to/monitor-openai.md) -->
