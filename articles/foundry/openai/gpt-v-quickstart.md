---
title: "Quickstart: Use vision-enabled chats with the Azure OpenAI in Microsoft Foundry Models (temp)"
description: "Use this article to get started using Azure OpenAI to deploy and use the GPT-4 Turbo with Vision model or other vision-enabled models. (temp)" 
manager: nitinme
ms.service: azure-ai-foundry
ms.subservice: azure-ai-foundry-openai
ms.custom:
  - devx-track-python, devx-track-js, devx-track-ts, dev-focus
  - classic-and-new
ms.topic: quickstart
...
# Quickstart: Use images in your AI chats (temp)
...
<!-- CLASSIC-ONLY: * Learn more about these APIs in the [Vision-enabled models how-to guide](./how-to/gpt-with-vision.md) -->
<!-- CLASSIC-ONLY: * [GPT-4 Turbo with Vision frequently asked questions](./faq.yml#gpt-4-turbo-with-vision) -->
