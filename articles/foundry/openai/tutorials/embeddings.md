---
title: "Azure OpenAI in Microsoft Foundry Models embeddings tutorial (temp)"
description: "Learn how to use Azure OpenAI's embeddings API for document search with the BillSum dataset (temp)"
manager: nitinme
