---
title: "Azure OpenAI in Microsoft Foundry Models REST API v1 preview reference (temp)"
description: "Learn how to use Azure OpenAI's latest v1 preview REST API. In this article, you learn about authorization options,  how to structure a request and receive a response. (temp)"
manager: nitinme
...
# Azure OpenAI in Microsoft Foundry Models REST API v1 preview reference (temp)
