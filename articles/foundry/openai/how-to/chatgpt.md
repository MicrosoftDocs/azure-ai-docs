---
title: "Work with chat completion models (temp)"
description: "Learn about the options for how to use models with the chat completions API (temp)"
...
# Work with chat completions models (temp)
