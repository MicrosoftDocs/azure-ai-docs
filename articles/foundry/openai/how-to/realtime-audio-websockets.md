---
title: "Use the GPT Realtime API via WebSockets (temp)"
description: "Learn how to use the GPT Realtime API for speech and audio via WebSockets. (temp)"
manager: nitinme
...
# Use the GPT Realtime API via WebSockets (temp)
