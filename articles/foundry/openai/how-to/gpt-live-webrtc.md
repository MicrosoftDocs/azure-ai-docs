...
- An ephemeral client token minted by your trusted backend. [TO VERIFY: exact ephemeral token minting endpoint for GPT-Live; the example below uses a placeholder `token` variable.]
