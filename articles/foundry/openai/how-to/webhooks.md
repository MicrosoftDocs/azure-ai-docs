---
title: "Azure OpenAI in Foundry Models Webhooks (temp)"
description: "Learn how to use webhooks with Azure OpenAI in Foundry Models. (temp)"
...
# Azure OpenAI in Foundry Models webhooks (temp)
