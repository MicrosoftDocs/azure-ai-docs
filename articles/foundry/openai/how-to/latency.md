...
<!-- CLASSIC-ONLY: Azure OpenAI includes a [content filtering system](content-filters.md) that works alongside the core models. This system works by running both the prompt and completion through an ensemble of classification models aimed at detecting and preventing the output of harmful content. -->
...
<!-- CLASSIC-ONLY: Learn more about requesting modifications to the default, [content filtering policies](content-filters.md). -->
...
<!-- CLASSIC-ONLY: You can learn more about [Monitoring Azure OpenAI](monitor-openai.md). -->
...
<!-- CLASSIC-ONLY: * **Content Filtering** improves safety, but it also impacts latency. Evaluate if any of your workloads would benefit from [modified content filtering policies](content-filters.md). -->
