---
title: "Data, privacy, and security for Speech to text (temp)"
titleSuffix: Foundry Tools
description: "This document details issues for data, privacy, and security for a Speech to text. (temp)"
...
# Data and Privacy for Speech to text (temp)
