...
:::image type="content" source="../openai/media/flow-3.png" alt-text="Data flow diagram for the service." lightbox="../openai/media/flow-3.png":::
...
To reduce the risk of abusive or harmful use, Models sold by Azure includes abuse monitoring features. To learn more about abuse monitoring, see [abuse monitoring](/azure/ai-foundry/openai/concepts/abuse-monitoring). 
...
Models sold by Azure include a system designed to detect and prevent the output of harmful content. To learn more about Guardrails (previously content filters), see [Guardrails](/azure/ai-services/openai/concepts/content-filter). 
...
2. Click on the **JSON view** link on the top right corner as shown in the image below.
    ...
    ![Logging status json view in the Azure portal.](../openai/media/logging-status-verification.png)
...
- [Transparency note and use cases for Azure OpenAI Service](../openai/transparency-note.md)
