...
:::image type="content" source="../agents/media/agents-diagram.png" alt-text="A diagram showing how Azure AI Agent Service processes data." lightbox="../agents/media/agents-diagram.png":::
