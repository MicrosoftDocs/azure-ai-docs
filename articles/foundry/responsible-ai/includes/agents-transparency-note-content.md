...
The following are key components of the Agent Service SDK (and the [Microsoft Foundry portal](https://ai.azure.com?cid=learnDocs) experience powered by it):
...
:::image type="content" source="../agents/media/agents-capabilities.jpg" alt-text="Diagram of Agent Service components and features.":::
...
* [Overview of Foundry Agent Service](/azure/ai-services/agents/overview)
* [Foundry Agent Service quickstart](/azure/ai-services/agents/quickstart?branch=release-azure-agents&pivots=programming-language-csharp)
