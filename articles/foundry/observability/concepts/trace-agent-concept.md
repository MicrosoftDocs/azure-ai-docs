---
title: "Agent tracing in Microsoft Foundry (preview) (temp)"
description: "Learn how agent tracing in Microsoft Foundry captures inputs, outputs, and tool usage with OpenTelemetry. Debug agent runs, identify latency issues, and improve reliability. (temp)"
...
---
# Agent tracing overview (preview) (temp)
