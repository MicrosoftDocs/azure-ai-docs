...
- Your Application Insights and Log Analytics configuration governs data retention and storage. For more information, see [Manage data retention in a Log Analytics workspace](/azure/azure-monitor/logs/data-retention-configure). 
