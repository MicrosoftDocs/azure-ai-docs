...
| **You want to test simulated multi-turn scenarios** | [Generate a simulation seed dataset](evaluation-dataset-synthetic.md#generate-a-simulation-seed-dataset-sdk) or author test case scenarios as JSONL, and then [simulate conversations](cloud-evaluation-simulate-conversations.md). |
