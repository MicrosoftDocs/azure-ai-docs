...
description: "Quick reference, detailed description, and best practices on the quotas and limits for the Microsoft Foundry service. (temp)"
...
<!-- CLASSIC-ONLY: This article provides a quick reference and detailed description of the quotas and limits for [Foundry Models sold directly by Azure](concepts/models-sold-directly-by-azure.md). For quotas and limits specific to the Azure OpenAI in Foundry Models, see [Quota and limits in Azure OpenAI](../openai/quotas-limits.md). -->
