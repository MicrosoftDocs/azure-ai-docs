...
<!-- CLASSIC-ONLY: * Read [what's new](../../openai/whats-new.md) and [models](models-sold-directly-by-azure.md) to understand the changes and new features. -->
<!-- CLASSIC-ONLY: * Read the documentation on [model deployments](../../openai/how-to/create-resource.md) and [version upgrades](../../openai/how-to/working-with-models.md) to understand how to work with model versions. -->
