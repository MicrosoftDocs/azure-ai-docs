...
<sup>4</sup> **Claude Mythos 5** and **Claude Fable 5** are Anthropic-designated [Covered Models](https://support.claude.com/en/articles/15425695-covered-models) that require data retention. To deploy and use these models, your Azure subscription must have zero data retention (ZDR) disabled. For more information, see [Data retention practices for Covered Models](https://support.claude.com/en/articles/15425996-data-retention-practices-for-covered-models).
