---
title: "Monitor Model Deployments in Microsoft Foundry Models (temp)"
description: "Learn how to use Azure Monitor tools like Log Analytics to capture and analyze metrics and data logs for Foundry Models. (temp)"
author: ssalgadodev
ms.author: ssalgado
...
# Monitor model deployments in Microsoft Foundry Models (temp)
...
<!-- CLASSIC-ONLY:     > If you're using serverless API endpoints and you want to take advantage of monitoring capabilities explained in this article, [migrate your serverless API endpoints to Foundry Models](./quickstart-ai-project.md). -->
