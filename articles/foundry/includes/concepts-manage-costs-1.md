...
- **Role-based access control (RBAC):** One or both of the following roles at the subscription or resource group scope:
  ...
  - [**Foundry User**](../concepts/rbac-foundry.md#built-in-roles) – View Foundry resource data and usage context.
...
- **View Foundry resources and related usage context:** [Foundry User](../concepts/rbac-foundry.md#built-in-roles).
