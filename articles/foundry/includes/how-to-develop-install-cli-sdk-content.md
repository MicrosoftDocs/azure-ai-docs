...
> When your environment is ready, continue to the [quickstart](../tutorials/quickstart-create-foundry-resources.md) for those instructions.
## Prerequisites
...
[!INCLUDE [Install Python](install-python.md)]
...
[!INCLUDE [Install Java](install-java.md)]
...
[!INCLUDE [install-csharp](install-csharp.md)]
