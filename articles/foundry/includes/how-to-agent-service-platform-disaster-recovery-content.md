...
>
> To understand platform limitations, prevention controls, and required baseline configuration, see the overview guide. For prerequisites and context, see [Foundry Agent Service disaster recovery](../how-to/agent-service-disaster-recovery.md). This article explains why some losses are unrecoverable and why recovery often means reconstruction rather than restoration.
>
> For recommendations on recovering from human-caused or automation-caused deletions and localized data loss, see [Resource and data loss recovery](../how-to/agent-service-operator-disaster-recovery.md).
...
- [Resource and data loss recovery strategies](../how-to/agent-service-operator-disaster-recovery.md) - Account for human-caused and automation-caused failures in your recovery design.
- [Foundry Agent Service disaster recovery overview](../how-to/agent-service-disaster-recovery.md) - Review prerequisites, platform limitations, and baseline configuration.
- [High availability and resiliency guidance](../how-to/high-availability-resiliency.md) - Design your workload for continuous availability.
