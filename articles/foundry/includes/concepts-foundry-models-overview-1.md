...
* [Foundry Models from partners and community](#models-from-partners-and-community)
...
You deploy models from partners and community by using *managed compute* or *serverless deployment* options. The model provider selects how the models are deployable. To learn about the differences between these deployment options, see [Model deployment options: managed compute and serverless deployments](#model-deployment-options-managed-compute-and-serverless-deployments).
...
- [Region availability for Foundry Models sold by Azure](../foundry-models/concepts/models-sold-directly-by-azure-region-availability.md)
- [Region availability for Foundry Models from partners and community](../foundry-models/concepts/models-from-partners.md#region-availability-by-deployment-type)
...
- [Retired Foundry Models](../openai/concepts/retired-models.md)
