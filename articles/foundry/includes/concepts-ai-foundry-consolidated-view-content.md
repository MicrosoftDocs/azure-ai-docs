...
- To view quota usage at subscription scope: the **Cognitive Services Usages Reader** role (recommended) or the **Reader** role. For more information, see [Role-based access control for Azure OpenAI in Microsoft Foundry Models](/azure/ai-foundry/openai/how-to/role-based-access-control).
