...
1. Managed virtual network is supported in all regions that the Foundry Agent service with custom virtual network is supported in. Please refer to Foundry Agent service documentation.
