...
- (Optional) Python packages for code samples: `pip install azure-identity requests`
...
Limitations: Higher initial setup complexity. Requires understanding of role-based access control (RBAC). For more on RBAC in Foundry, see [Role-based access control for Microsoft Foundry](../concepts/rbac-foundry.md).
...
**Reference**: [Assign Azure roles](/azure/role-based-access-control/role-assignments-portal) | [Role-based access control for Foundry](../concepts/rbac-foundry.md)
