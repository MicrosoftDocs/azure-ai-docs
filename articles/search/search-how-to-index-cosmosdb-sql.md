...
1. On **Connect to your data**, select or verify that the data source type is either *Azure Cosmos DB* or a *NoSQL account*.
   ...
   The data source name refers to the data source connection object in Azure AI Search. Your data source name is autogenerated using a custom prefix that you specify at the end of the wizard workflow.
...
1. You can specify options for change and deletion tracking.
