...
+ Azure AI Search, in any [region that provides agentic retrieval](search-region-support.md), on the basic pricing tier or higher for managed identity support. Your search service must have a [managed identity](search-how-to-managed-identities.md) for role-based access to deployed models.
