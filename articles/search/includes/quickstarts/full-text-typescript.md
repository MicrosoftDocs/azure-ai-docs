...
Document inputs might be rows in a database, blobs in Blob storage, or, as in this sample, JSON documents on disk. The hotel data is imported at the top of the file:
