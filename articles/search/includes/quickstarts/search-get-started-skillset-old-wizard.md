...
1. Select **Free (Limited enrichments)** to use a free Azure AI Foundry resource.

   :::image type="content" source="../../media/search-get-started-skillset/cog-search-attach.png" alt-text="Screenshot of the Attach Azure AI Foundry tab." border="true" lightbox="../../media/search-get-started-skillset/cog-search-attach.png":::

   The sample data consists of 14 files, so the free allotment of 20 transactions on Azure AI Foundry is sufficient.
