...
You can specify a [geo-spatial filter](../../search-query-odata-geo-spatial-functions.md) to limit results to a specific geographic area. `searchSingleWithFilterGeo.js` limits results to hotels within 300 kilometers of Washington D.C.
