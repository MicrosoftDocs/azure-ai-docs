...
After you run the project, the following output is displayed:
...
The hybrid query with semantic ranking is filtered to show only the hotels within a 300-kilometer radius of Washington D.C.
