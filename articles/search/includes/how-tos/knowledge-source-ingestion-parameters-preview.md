...
| `AssetStore` | (2026-05-01-preview only) An Azure Blob container used to persist images extracted from source documents. Required to enable [image serving](../../agentic-retrieval-how-to-image-serving.md) (preview) for the knowledge base. Setting this parameter provisions a [knowledge store](../../knowledge-store-concept-intro.md) alongside the knowledge source to store the image artifacts; you can inspect and manage the knowledge store like any other. The storage account must remain accessible to the search service for the lifetime of the knowledge base. | Object | No | No |
...
| `asset_store` | (2026-05-01-preview only) An Azure Blob container used to persist images extracted from source documents. Required to enable [image serving](../../agentic-retrieval-how-to-image-serving.md) (preview) for the knowledge base. Setting this parameter provisions a [knowledge store](../../knowledge-store-concept-intro.md) alongside the knowledge source to store the image artifacts; you can inspect and manage the knowledge store like any other. The storage account must remain accessible to the search service for the lifetime of the knowledge base. | Object | No | No |
