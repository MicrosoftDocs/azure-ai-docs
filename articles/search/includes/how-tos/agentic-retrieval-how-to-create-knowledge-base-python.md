...
You can create a knowledge base in a [Foundry IQ workload](/azure/ai-foundry/agents/how-to/foundry-iq-connect) in the Microsoft Foundry (new) portal. You also need a knowledge base in any agentic solutions that you create using the Azure AI Search APIs.
