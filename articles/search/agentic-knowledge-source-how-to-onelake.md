...
> [!TIP]
> To surface document-embedded images (such as diagrams or charts) in answer synthesis responses, configure `assetStore` on this knowledge source and enable image serving on the knowledge base. For more information, see [Image serving in agentic retrieval (preview)](agentic-retrieval-how-to-image-serving.md).
