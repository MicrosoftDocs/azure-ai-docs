...
Azure AI Search uses dedicated, internally hosted multi-service resources for built-in skills processing, but needs your multi-service account for billing purposes. 
