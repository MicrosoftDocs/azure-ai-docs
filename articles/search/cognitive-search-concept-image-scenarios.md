...
> Currently, images extracted using imageAction: generateNormalizedImages will always produce a single polygon, but the double-nested structure is maintained for consistency with the Document Intelligence Skill, which supports multiple polygons.
