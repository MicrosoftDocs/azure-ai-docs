...
#customer intent: As an application developer, I want to build an end-to-end agentic retrieval solution so that a Foundry agent can use an Azure AI Search knowledge base through MCP.
---
