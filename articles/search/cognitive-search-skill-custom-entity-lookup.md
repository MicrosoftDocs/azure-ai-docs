...
> [!NOTE]
> This skill isn't bound to an Azure AI Foundry Tools API but requires an Azure AI Foundry Tools key to allow more than 20 transactions. This skill is [metered by Azure AI Search](https://azure.microsoft.com/pricing/details/search/#pricing).
