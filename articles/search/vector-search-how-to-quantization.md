...
New rescoring options for binary quantization is a preview feature. API versions determine which rescoring behavior is operational for your code. 

| API version | Quantization type | Query parameters |
|-------------|-------------------|------------------|
