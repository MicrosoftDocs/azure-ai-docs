...
#customer intent: As an application developer, I want to create a Fabric Data Agent knowledge source so that my knowledge base can return live, permission-aware answers from Fabric data.
---
