...
#customer intent: As an application developer, I want to understand the governance requirements and create, use, query, and delete a Fabric Data Agent knowledge source so that my knowledge base can return live, permission-aware answers, tables, and charts from Fabric data.
---
