...
> [!IMPORTANT]
> + CMK provides encryption for data at rest. If you need to protect data in use, consider using [confidential computing](search-security-built-in.md#data-in-use).
>
