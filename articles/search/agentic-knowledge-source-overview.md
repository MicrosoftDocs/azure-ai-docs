...
| [File (preview)](agentic-knowledge-source-how-to-file.md) | Provides a managed direct-upload experience for small-to-medium file sets, up to 100 files. | Indexed |
