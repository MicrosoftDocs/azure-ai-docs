...
| [`"fabricDataAgent"` API](/rest/api/searchservice/knowledge-sources/create-or-update?view=rest-searchservice-2026-05-01-preview&preserve-view=true#fabricdataagentknowledgesource) queries a Microsoft Fabric data agent directly. | Remote |
