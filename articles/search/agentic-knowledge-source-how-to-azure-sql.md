...
#customer intent: As an application developer, I want to create an indexed Azure SQL knowledge source with appropriate column mappings, authentication, and change detection so that current rows from a SQL table or view can ground agentic retrieval responses.
---
