...
| [**Document Layout skill**](cognitive-search-document-layout.md) | Applied AI (skills) | A new skill used to analyze a document for structure. | [Create or Update Skillset (preview)](/rest/api/searchservice/skillsets/create-or-update?view=rest-searchservice-2024-11-01-preview&preserve-view=true). |
