...
| Feature | Description | Availability |
|--|--|--|
| [**Serverless pricing model**](search-sku-tier.md) | Consumption-based pricing model where you pay only for compute (CUs/hr) and indexed storage (GB/month) consumed. Compute scales to zero when idle with no minimum capacity charge. | [Services - Create or Update (preview)](/rest/api/searchmanagement/services/create-or-update?view=rest-searchmanagement-2026-03-01-preview&preserve-view=true) |
