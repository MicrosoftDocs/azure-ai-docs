...
Logic apps integration includes the following indexing actions. For more information, see [Connect to Azure AI Foundry Tools from workflows in Azure Logic Apps](/azure/logic-apps/connectors/azure-ai#ingest-data-workflow).
...
+ [Connect to Azure AI Foundry Tools from workflows in Azure Logic Apps](/azure/logic-apps/connectors/azure-ai)
