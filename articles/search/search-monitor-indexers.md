...
Warnings are common with some types of indexers, and don't always indicate a problem. For example indexers that use Azure AI Foundry Tools can report warnings when image or PDF files don't contain any text to process. 
