...
## Sample: Semantic Chunking and vectorization
Markdown is a structured and formatted markup language and a popular input for enabling semantic chunking in RAG (Retrieval-Augmented Generation). You can use the Markdown content from the **Document Intelligence Layout** skill to split documents based on paragraph boundaries, and fine-tune your chunking strategy to improve the quality of the generated responses.

### Sample definition

This definition
+ Use **Document Intelligence Layout** Skill to get markdown sections
+ Generate embeddings for content in markdown sections using [Azure Open AI Embedding Skill](cognitive-search-skill-azure-openai-embedding.md)
+ Use [index projections](/azure/search/search-how-to-define-index-projections) to compose them and write into a search index
...
```json
{
  ...
  "indexProjections": {
    "selectors": [
      {
        "targetIndexName": "markdownDocument-sample",
