...
keywords: agentic retrieval, agentic rag, azure ai search
ms.date: 03/11/2026
...
+ [Call the retrieve action or MCP endpoint to query a knowledge base](agentic-retrieval-how-to-retrieve.md)
