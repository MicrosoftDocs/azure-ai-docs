...
Location: https://<YOUR-SEARCH-SERVICE-NAME>.search.windows.net:443/datasources('ny-philharmonic-ds')?api-version=@search.rerankerBoostedScore
...
```http
### Query the index
POST {{baseUrl}}/indexes/ny-philharmonic-index/docs/search?api-version=@search.rerankerBoostedScore  HTTP/1.1
  Content-Type: application/json
  api-key: {{apiKey}}
...

{
  ...
  "@odata.nextLink": "https://<YOUR-SEARCH-SERVICE-NAME>.search.windows.net/indexes/ny-philharmonic-index/docs/search?api-version=@search.rerankerBoostedScore"
}
```
...
```http
### Reset the indexer
POST {{baseUrl}}/indexers/ny-philharmonic-indexer/reset?api-version=@search.rerankerBoostedScore  HTTP/1.1
  api-key: {{apiKey}}
```

```http
### Run the indexer
POST {{baseUrl}}/indexers/ny-philharmonic-indexer/run?api-version=@search.rerankerBoostedScore  HTTP/1.1
  api-key: {{apiKey}}
```

```http
### Check indexer status 
GET {{baseUrl}}/indexers/ny-philharmonic-indexer/status?api-version=@search.rerankerBoostedScore  HTTP/1.1
  api-key: {{apiKey}}
```
