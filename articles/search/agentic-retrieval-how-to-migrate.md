...
| Java | Use `KnowledgeBaseRetrievalClientBuilder`, `KnowledgeBaseRetrievalOptions`, and `KnowledgeRetrievalSemanticIntent` to issue intent-based retrieve calls and read results as `KnowledgeBaseRetrievalResult`. |
