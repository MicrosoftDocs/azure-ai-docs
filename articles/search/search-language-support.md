...
This article assumes translated strings already exist. If that's not the case, you can attach Azure AI Foundry Tools to an [enrichment pipeline](cognitive-search-concept-intro.md), invoking text translation during indexing. Text translation takes a dependency on the indexer feature and Azure AI Foundry Tools, but all setup is done within Azure AI Search. 
