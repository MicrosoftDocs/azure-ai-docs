...
> [!NOTE]
> An indexer also connects to Azure AI Foundry Tools for built-in skills. However, that connection is made over the internal network and isn't subject to any network provisions under your control.
