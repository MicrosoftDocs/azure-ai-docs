...
```json
"@odata.nextLink": "https://contoso-search-eastus.search.windows.net/indexes/realestate-us-sample-index/docs/search?api-version=@search.rerankerBoostedScore"
```
...
```http
POST https://contoso-search-eastus.search.windows.net/indexes/realestate-us-sample-index/docs/search?api-version=@search.rerankerBoostedScore
...
1. Issue a query to return a full page of sorted results.
    ...
    ```http
    POST /indexes/good-books/docs/search?api-version=@search.rerankerBoostedScore
        {  
