...
|429 | Too Many Requests | Yes | If you get this error code during indexing, it usually means that you're running low on storage. As you near [storage limits](/azure/search/search-limits-quotas-capacity), the service can enter a state where you can't add or update until you delete some documents. For more information, see [Plan and manage capacity](/azure/search/search-capacity-planning#how-to-upgrade-capacity) if you want more storage, or free up space by deleting documents. |  
