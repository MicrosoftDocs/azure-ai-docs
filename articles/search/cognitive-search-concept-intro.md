...
[Built-in skills](cognitive-search-predefined-skills.md) tap Azure AI Foundry Tools. They apply the following transformations and processing to raw content:
...
+ Multimodal embeddings via Azure Vision for text and image vectorization.
...
AI enrichment is available in regions that offer Azure AI Foundry Tools. To check the availability of AI enrichment, see the [regions list](search-region-support.md).
