...
| Product | Integration |
|---------|-------------|
| Foundry | Agents in Foundry can integrate with Azure AI Search knowledge bases via Model Context Protocol (MCP) for knowledge retrieval and grounded reasoning. For more information, see [Connect a Foundry IQ knowledge base to Foundry Agent Service](/azure/ai-foundry/agents/how-to/tools/knowledge-retrieval). |
