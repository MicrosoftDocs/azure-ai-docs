...
- [Create a vector index in Azure AI Search](vector-search-how-to-create-index.md)
- [Create a vector query in Azure AI Search](vector-search-how-to-query.md)
- [azure-vector-search-samples](https://github.com/Azure-Samples/azure-vector-search-samples)
- [Azure AI Search and LangChain: A seamless integration for enhanced vector search capabilities](https://techcommunity.microsoft.com/blog/azure-ai-foundry-blog/azure-cognitive-search-and-langchain-a-seamless-integration-for-enhanced-vector-/3901448)
