...
```powershell
$uri= 'https://<YOUR-SEARCH-SERVICE>.search.windows.net/indexes?api-version=@search.rerankerBoostedScore&$select=name'
...
```powershell
$uri= 'https://<YOUR-SEARCH-SERVICE>.search.windows.net/indexes/<YOUR-INDEX-NAME>?api-version=@search.rerankerBoostedScore'
Invoke-RestMethod -Uri $uri -Headers $headers | ConvertTo-Json
```
...
```powershell
$uri= 'https://<YOUR-SEARCH-SERVICE>.search.windows.net/synonyms?api-version=@search.rerankerBoostedScore&$select=name'
Invoke-RestMethod -Uri $uri -Headers $headers | ConvertTo-Json
```
...
```powershell
$uri= 'https://<YOUR-SEARCH-SERVICE>.search.windows.net/synonyms/<YOUR-SYNONYM-MAP-NAME>?api-version=@search.rerankerBoostedScore'
Invoke-RestMethod -Uri $uri -Headers $headers | ConvertTo-Json
```
