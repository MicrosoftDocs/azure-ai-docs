...
description: Learn how to create and query an index in agentic retrieval workloads.
...
# Use agentic retrieval in Azure AI Search
...
Azure AI Search needs access to the chat completion model. If you're using role-based authentication, on your Azure OpenAI resource, assign the **Cognitive Services User** role to a search service managed identity.

## Create an index for agentic retrieval

Use the 2025-05-01-preview data plane REST API or an Azure SDK prerelease package that provides equivalent functionality.

## Build queries for agentic retrieval
