...
#customer intent: As an application developer, I want to configure and validate freshness-aware retrieval so that newer indexed content receives a ranking preference.
---
