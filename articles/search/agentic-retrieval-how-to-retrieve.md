...
| [Fabric Ontology](agentic-knowledge-source-how-to-fabric-ontology.md#enforce-permissions-at-query-time) | ❌ | The Fabric ontology is queried using the user's token via an on-behalf-of exchange. |
