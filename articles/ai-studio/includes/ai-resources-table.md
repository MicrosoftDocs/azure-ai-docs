...
| [Azure AI Model Inference service](../../ai-foundry/model-inference/index.yml) | Consume models as APIs without hosting them on your infrastructure. Includes models from OpenAI, Microsoft, Meta, Mistral, Cohere, G42, and AI21 Labs.|
