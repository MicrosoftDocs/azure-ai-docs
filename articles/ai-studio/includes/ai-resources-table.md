...
| Service | Description |
| --- | --- |
| ![Azure AI Agent Service icon](~/reusable-content/ce-skilling/azure/media/ai-services/ai-agents.png) [Azure AI Agent Service](../../ai-services/agents/index.yml) | Develop AI agents to automate and xecute business processes. |
