...
In this documentation pages, we will refer to both Azure AI Studio and Azure Machine Learning Studio. Please visit the following page, to learn more about differences between these two products: [AI Studio or Azure Machine Learning: Which experience should I choose?](/ai/ai-studio-experiences-overview)
