...
| ----------- | ----------| ----------- | ------------|
| [Azure AI Basic Template with Python](https://github.com/azure-samples/azureai-basic-python) | [Azure AI Studio online endpoints](/azure/machine-learning/concept-endpoints-online) | [Azure Managed Identity](/entra/identity/managed-identities-azure-resources/overview), [Azure OpenAI Service](../../../ai-services/openai/overview.md), Bicep | The app provides a straightforward example of using Azure OpenAI Service in a basic chat application. This template guides you in connecting to your project and covers the essentials for building and deploying a chat app that leverages models and prompts. You can build, deploy, and test it with a single command. |
