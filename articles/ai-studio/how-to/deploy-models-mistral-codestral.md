...
In this article, you learn about Codestral chat model and how to use them.
Mistral AI offers two categories of models, namely:

- Premium models: These models are available as serverless APIs with pay-as-you-go token-based billing and include [Mistral Large, Mistral Small, and Ministral 3B](deploy-models-mistral.md).  
- Open models: These models include Codestral and [Mistral Nemo](deploy-models-mistral-nemo.md) (available as serverless APIs with pay-as-you-go token-based billing), and [Mixtral-8x7B-Instruct-v01, Mixtral-8x7B-v01, Mistral-7B-Instruct-v01, and Mistral-7B-v01](deploy-models-mistral-open.md)(available to download and run on self-hosted managed endpoints).
