...
1. From the top of the page, select __Connect__ and then __Connect via Bastion__.
    ...
    > [!TIP]
    > Azure Bastion uses port 443 for inbound communication. If you have a firewall that restricts outbound traffic, ensure that it allows traffic on port 443 to the Azure Bastion service. For more information, see [Wroking with NSGs and Azure Bastion](/azuree/bastion/bastion-nsg).
