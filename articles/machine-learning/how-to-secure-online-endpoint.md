...
* A Bash shell or a compatible shell, for example on a Linux system or [Windows Subsystem for Linux](/windows/wsl/about). The CLI examples in this article assume that you use this type of shell.
