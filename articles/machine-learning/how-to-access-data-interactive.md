...
>
> For large datasets, we recommend use of Azure Machine Learning managed Spark. This provides the [Pandas API on Spark](https://spark.apache.org/docs/latest/api/python/tutorial/pandas_on_spark/index.html).
