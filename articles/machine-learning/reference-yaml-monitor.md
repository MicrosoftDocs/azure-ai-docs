...
| `alert_notification` | Object or string | Description of alert notification recipients. | The allowed alert destination is an object  `emails`  containing an array of email recipients |  |
