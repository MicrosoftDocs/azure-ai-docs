...
| `alert_notification` | Object&nbsp;~~or String~~ | Description of alert notification recipients. | alert destinations is allowed: Object `emails` containing an array of email recipients ~~or String `azmonitoring`~~ |  |
