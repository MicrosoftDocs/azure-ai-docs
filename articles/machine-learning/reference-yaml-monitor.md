...
| `alert_notification` | Object or string | Description of alert notification recipients. | An object with an `emails` property containing an array of email recipients, or the string `azmonitoring` |  |
