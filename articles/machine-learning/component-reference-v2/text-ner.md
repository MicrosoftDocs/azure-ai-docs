...
Named Entity Recognition (NER) is one of the features offered by Azure Language in Foundry Tools. The NER feature can identify and categorize entities in unstructured text. For [more information on NER](/azure/ai-services/language-service/named-entity-recognition/overview)
