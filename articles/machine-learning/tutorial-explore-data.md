...
You want to create data assets for frequently accessed data. You can access the data using the URI as described in [Access data from a datastore URI as you would from a filesystem](how-to-access-data-interactive.md#access-data-from-a-datastore-uri-as-you-would-from-a-file-system).  However, as mentioned previously, it can become difficult to remember these URIs. 
