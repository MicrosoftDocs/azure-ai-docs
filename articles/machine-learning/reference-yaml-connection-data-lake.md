...
While the `az ml connection` commands can be used to manage both Azure Machine Learning and Microsoft Foundry connections, the Azure Data Lake Store Gen 2 connection is specific to Foundry.
