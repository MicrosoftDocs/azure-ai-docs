...
:::image type="content" source="./media/how-to-auto-train-forecast/target-roll.svg" alt-text="Diagram of a table with data that shows the target rolling window and the values in the Demand column highlighted.":::
