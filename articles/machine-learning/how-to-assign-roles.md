...
| ----- | ----- | ----- | ----- |
| Create new workspace <sub>1</sub> | Not required | Owner, contributor, or custom role allowing: `Microsoft.Resources/deployments/*` | Any role allowing: `Microsoft.MachineLearningServices/workspaces/write` |
