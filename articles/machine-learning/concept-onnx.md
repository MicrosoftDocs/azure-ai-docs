...
- [Train a new ONNX model in Azure Machine Learning](https://github.com/onnx/onnx/tree/main) or use [automated machine learning capabilities](concept-automated-ml.md#automl--onnx).
