...
While the `az ml connection` commands can be used to manage both Azure Machine Learning and Microsoft Foundry connections, the API key connection is specific to Foundry.
