...
This article describes how to create an Azure pipeline that builds and deploys a machine learning model to [Azure Machine Learning](overview-what-is-azure-machine-learning.md).

This tutorial uses the [Azure Machine Learning Python SDK v2](/python/api/overview/azure/ai-ml-readme) and the [Azure CLI ML extension v2](/cli/azure/ml).
