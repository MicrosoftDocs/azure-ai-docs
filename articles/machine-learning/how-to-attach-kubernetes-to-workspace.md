...
After you deploy the Azure Machine Learning extension on an AKS or Arc Kubernetes cluster, you can attach the Kubernetes cluster to an Azure Machine Learning workspace. You can also create compute targets for ML professionals to use. 
