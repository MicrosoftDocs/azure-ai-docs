---
title: How to use Phi-3 family chat models with Azure Machine Learning
titleSuffix: Azure Machine Learning
description: Learn how to use Phi-3 family chat models with Azure Machine Learning.
...
To use Phi-3 family chat models with Azure Machine Learning, you need the following prerequisites:
...
> [!TIP]
> The [Azure AI model inference API](https://aka.ms/azureai/modelinference) allows you to talk with most models deployed in [Azure AI Foundry portal](https://ai.azure.com/) with the same code and structure, including Phi-3 family chat models.
...
To use Phi-3 family chat models with Azure Machine Learning studio, you need the following prerequisites:
...
> [!TIP]
> The [Azure AI model inference API](https://aka.ms/azureai/modelinference) allows you to talk with most models deployed in Azure Machine Learning studio with the same code and structure, including Phi-3 family chat models.
