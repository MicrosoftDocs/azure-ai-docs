...
1. Studio remembers where you were last, so what you do next depends on where you are:
    ...
    * If you're already in a project and want to use a new one, select **Microsoft Foundry** in the top left corner, then select **Create new** to create the new project.
    * If you're new to Foundry and don't have any projects, use [Quickstart: Get started with Foundry](../quickstarts/get-started-code.md) instead of this article.
