...
---
 ...
 To create a [!INCLUDE [hub-project-name](../../foundry/includes/hub-project-name.md)] in [Microsoft Foundry](https://ai.azure.com/?cid=learnDocs), follow these steps:
...
1. If you have a hub, you'll see the one you most recently used selected.  
   ...
   * If you want to create a new one, select **Create a new hub** from the dropdown.  
      ...
      :::image type="content" source="../../foundry/media/how-to/projects/projects-create-details.png" alt-text="Screenshot of the project details page within the create project dialog." lightbox="../../foundry/media/how-to/projects/projects-create-details.png":::
