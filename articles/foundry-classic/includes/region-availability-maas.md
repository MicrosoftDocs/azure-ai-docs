...
|-------------------|---------|-------------------------------------|---------|
| Claude Mythos Preview<sup>2</sup> (gated research preview) <br> Claude Opus 4.8 (preview) <br> Claude Opus 4.7 (preview) <br>  Claude Opus 4.6 (preview)  <br> Claude Opus 4.5 (preview) <br> Claude Opus 4.1 (preview) <br> Claude Sonnet 4.6 (preview) <br> Claude Sonnet 4.5 (preview) <br> Claude Haiku 4.5 (preview)| [Microsoft Managed Countries/Regions](/partner-center/marketplace/tax-details-marketplace#microsoft-managed-countriesregions)—**except** *Belarus* and *Russia* | East US 2 <br> Sweden Central    | Not available |
