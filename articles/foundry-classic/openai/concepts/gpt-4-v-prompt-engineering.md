---
title: "Image prompt engineering techniques (classic)"
description: "Learn how to better engineer image prompts for vision-enabled chat models. (classic)"
...
# Image prompt engineering techniques (classic)
...
|Basic prompt|Model output|
|--------|-----------|
| :::image type="content" source="../../../foundry/openai/media/concepts/gpt-v/dinner-spread.jpg" lightbox="../../../foundry/openai/media/concepts/gpt-v/dinner-spread.jpg" alt-text="Photograph of a dinner table with several plates of food."::: Plan this meal | `Sorry, I can't provide that information.` |
