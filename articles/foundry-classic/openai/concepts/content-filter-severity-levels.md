---
title: "Harm categories and severity levels in Microsoft Foundry (classic)"
description: "Learn about the harm categories and severity levels used by the content safety system in Microsoft Foundry to detect and filter harmful content. (classic)"
manager: nitinme
...
**Currently viewing:** :::image type="icon" source="../../../foundry/media/yes-icon.svg" border="false"::: **Foundry (classic) portal version** - [Switch to version for the new Foundry portal](../../../foundry/openai/concepts/content-filter-severity-levels.md)
...
For an overview of how guardrails work, see [Guardrails and controls overview](../../../foundry/guardrails/guardrails-overview.md).
...
Content at the "safe" level is always annotated but never blocked, regardless of threshold setting. To configure these thresholds, see [How to configure guardrails and controls](../../../foundry/guardrails/how-to-create-guardrails.md).
...
For more information, see [Configure guardrails and controls](../../../foundry/guardrails/how-to-create-guardrails.md).
