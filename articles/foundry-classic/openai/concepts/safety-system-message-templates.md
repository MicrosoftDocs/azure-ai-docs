...
**Currently viewing:** :::image type="icon" source="../../../foundry/media/yes-icon.svg" border="false"::: **Foundry (classic) portal version** - [Switch to version for the new Foundry portal](../../../foundry/openai/concepts/safety-system-message-templates.md)
...
To reduce risk, combine system messages with other mitigations such as content filtering. See [Content filtering overview](../../foundry-models/concepts/content-filter.md) and the [Azure AI Content Safety quickstart](/azure/ai-services/content-safety/quickstart-text) for layered protection.
...
- Layer mitigations with [Content filtering overview](../../foundry-models/concepts/content-filter.md).
