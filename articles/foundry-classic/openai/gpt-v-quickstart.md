---
title: "Quickstart: Use vision-enabled chats with the Azure OpenAI in Microsoft Foundry Models (classic)"
description: "Use this article to get started using Azure OpenAI to deploy and use the GPT-4 Turbo with Vision model or other vision-enabled models. (classic)" 
manager: nitinme
