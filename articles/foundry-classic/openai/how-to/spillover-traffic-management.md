...
1. Add the `Azure OpenAI Requests` metric.
    ...
    :::image type="content" source="../../../foundry/openai/media/provisioned/spillover-metrics-menu.png" alt-text="A screenshot showing the metrics for a basic spillover example in the Azure portal." lightbox="../../../foundry/openai/media/provisioned/spillover-metrics-menu.png":::
...
1. Select **Apply splitting** and apply the `ModelDeploymentName` split and `StatusCode` splits to the `Azure OpenAI Requests` metric. This shows a chart with the `200` (success) and `429` (too many requests) response codes generated for your resource.   
    ...
    :::image type="content" source="../../../foundry/openai/media/provisioned/add-splitting.png" alt-text="A screenshot showing the menu for adding splits in the Azure portal." lightbox="../../../foundry/openai/media/provisioned/add-splitting.png":::
    
    Be sure to add the model deployments you want to view when applying the `ModelDeploymentName` split.

    :::image type="content" source="../../../foundry/openai/media/provisioned/model-filter.png" alt-text="A screenshot showing the available model filters." lightbox="../../../foundry/openai/media/provisioned/model-filter.png":::
    ...
    :::image type="content" source="../../../foundry/openai/media/provisioned/spillover-chart-simplified.png" alt-text="A screenshot showing the metrics for visualizing spillover." lightbox="../../../foundry/openai/media/provisioned/spillover-chart-simplified.png":::
    ...
    > :::image type="content" source="../../../foundry/openai/media/provisioned/spillover-chart-errors.png" alt-text="A screenshot showing the response codes from a provisioned deployment." lightbox="../../../foundry/openai/media/provisioned/spillover-chart-errors.png":::
...
:::image type="content" source="../../../foundry/openai/media/provisioned/spillover-chart.png" alt-text="A screenshot showing the spillover split in Azure portal." lightbox="../../../foundry/openai/media/provisioned/spillover-chart.png":::
