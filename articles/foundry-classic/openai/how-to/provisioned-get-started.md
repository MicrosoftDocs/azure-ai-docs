---
title: "Get started with provisioned deployments in Microsoft Foundry (classic)"
...
<!-- NEW-ONLY: In this event, the wizard in [!INCLUDE [foundry-link](../../includes/foundry-link.md)] will direct you to other regions with available quota and capacity to create a deployment of the desired model. If this happens, the deployment dialog will look like this: -->
