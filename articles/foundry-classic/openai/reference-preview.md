---
title: "Azure OpenAI in Microsoft Foundry Models REST API preview reference (classic)"
description: "Learn how to use Azure OpenAI's latest preview REST API. In this article, you learn about authorization options,  how to structure a request and receive a response. (classic)"
manager: nitinme
...
# Azure OpenAI in Microsoft Foundry Models REST API preview reference (classic)
