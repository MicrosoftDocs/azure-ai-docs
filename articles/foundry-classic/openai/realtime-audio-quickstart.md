---
title: "How to use GPT Realtime API for speech and audio with Azure OpenAI in Microsoft Foundry Models (classic)"
description: "Learn how to use GPT Realtime API for speech and audio with Azure OpenAI. (classic)"
manager: nitinme
