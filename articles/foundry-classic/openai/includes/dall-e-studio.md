...
description: Learn how to generate images with Azure OpenAI in the images playground in Microsoft Foundry.
manager: nitinme
...
> [!NOTE]
> The Image APIs come with a content moderation filter. If Azure OpenAI recognizes your prompt as harmful content, it doesn't return a generated image. For more information, see [Content filtering](../../foundry-models/concepts/content-filter.md).
