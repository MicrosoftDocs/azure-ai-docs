...
:::image type="content" source="../../../foundry/openai/media/quickstarts/endpoint.png" alt-text="Screenshot of the overview UI for an Azure OpenAI resource in the Azure portal with the endpoint & access keys location highlighted." lightbox="../../../foundry/openai/media/quickstarts/endpoint.png":::
