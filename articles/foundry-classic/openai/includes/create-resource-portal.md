...
1. Select the desired model and then select **Confirm**. For a list of available models per region, see [Region availability for Foundry Models sold directly by Azure](../../../foundry/foundry-models/concepts/models-sold-directly-by-azure-region-availability.md).
