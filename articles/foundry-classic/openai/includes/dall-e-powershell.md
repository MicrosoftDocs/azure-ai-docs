...
1. Replace the contents of _quickstart.ps1_ with the following code. Make sure `AZURE_OPENAI_ENDPOINT` is set, and change the value of `prompt` to your preferred text.
   ...
   ```powershell
    ...
    $openai = @{
        ...
        deployment  = 'gpt-image-1' # your GPT-image-1 series deployment name
    }
    ...
    # Retrieve the generated image (GPT-image-1 returns base64-encoded data)
    $image_base64 = $response.data[0].b64_json
    [System.IO.File]::WriteAllBytes($image_path, [System.Convert]::FromBase64String($image_base64))
    return $image_path
   ```
