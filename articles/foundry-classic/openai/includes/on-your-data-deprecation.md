...
> + GPT-4o-mini (version 2024-07-18) [Once this model retires](../concepts/model-retirements.md), all Azure OpenAI On Your Data API endpoints and supported data source connectors stop functioning.
> 
