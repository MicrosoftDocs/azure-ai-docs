...
> [!TIP]
> The rest of this article shows how to create and use a **[!INCLUDE [fdp](../../foundry/includes/fdp-project-name.md)]**. [Which type of project do I need?](../what-is-foundry.md#which-type-of-project-do-i-need)
