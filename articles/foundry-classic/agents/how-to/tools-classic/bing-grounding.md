...
> 2. Only Paid and Pay-as-you-go Azure subscriptions are eligible for Grounding with Bing Search. Sponsored or subscriptions based on free credit are not eligible to deploy Grounding with Bing Search. 
