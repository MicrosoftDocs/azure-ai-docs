---
title: "Monitor Foundry Agent Service with Azure Monitor (classic)"
description: "Learn how to use Azure Monitor to view, analyze, and alert on platform metrics for Foundry Agent Service, including Log Analytics export and KQL queries. (classic)"
ms.date: 02/03/2026
ms.custom:
...
>
> See [Monitor AI Agents with the Agent Monitoring Dashboard (preview)](/azure/foundry/observability/how-to/how-to-monitor-agents-dashboard).
...
- If you're using a Foundry project, see [Monitor AI Agents with the Agent Monitoring Dashboard (preview)](/azure/foundry/observability/how-to/how-to-monitor-agents-dashboard).
