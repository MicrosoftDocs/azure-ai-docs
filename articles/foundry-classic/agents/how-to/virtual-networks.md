---
title: "How to use a virtual network with the Foundry Agent Service (classic)"
description: "Learn how to use your own virtual network with the Foundry Agent Service. (classic)" 
