---
title: "General Purpose Evaluators for Generative AI (classic)"
description: "Learn about general-purpose evaluators for generative AI, including coherence, fluency, and question-answering composite evaluation. (classic)"
...
# General purpose evaluators (classic)

**Currently viewing:** :::image type="icon" source="../../../foundry/media/yes-icon.svg" border="false"::: **Foundry (classic) portal version** - [Switch to version for the new Foundry portal](../../../foundry/concepts/evaluation-evaluators/general-purpose-evaluators.md)
