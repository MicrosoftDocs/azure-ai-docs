...
Customer-managed key (CMK) encryption in [!INCLUDE [foundry-link](../../foundry/includes/foundry-link.md)] gives you control over encryption of your data. Use CMKs to add an extra protection layer and help meet compliance requirements with Azure Key Vault integration.
