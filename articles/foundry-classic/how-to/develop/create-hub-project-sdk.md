...
> [!NOTE]
> A hub is used only for a **[!INCLUDE [hub](../../includes/hub-project-name.md)]**. A **[!INCLUDE [fdp](../../../foundry/includes/fdp-project-name.md)]** doesn't use a hub. For more information, see [Types of projects](../../what-is-foundry.md#types-of-projects).
