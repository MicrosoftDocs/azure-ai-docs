...
description: "Use this article to learn how to create projects and deploy Large Language Models using Microsoft Foundry capabilities directly in VS Code. (classic)"
manager: mcleans
...
# Work with the Microsoft Foundry for Visual Studio Code extension (Preview) (classic)
