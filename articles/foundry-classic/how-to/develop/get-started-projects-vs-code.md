...
# Work with the Microsoft Foundry for Visual Studio Code extension (classic)

**Currently viewing:** :::image type="icon" source="../../../foundry/media/yes-icon.svg" border="false"::: **Foundry (classic) portal version** - [Switch to version for the new Foundry portal](../../../foundry/how-to/develop/get-started-projects-visual-studio-code.md)
...
[!INCLUDE [get-started-projects-vs-code 1](../../../foundry/includes/how-to-develop-get-started-projects-vs-code-1.md)]
...
[!INCLUDE [get-started-projects-vs-code 2](../../../foundry/includes/how-to-develop-get-started-projects-vs-code-2.md)]
