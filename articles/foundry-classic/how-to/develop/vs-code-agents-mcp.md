---
title: "Work with Foundry Agent Service and MCP Server Tools in Visual Studio Code (classic)"
description: "Use this article to learn how to use MCP server tools with Foundry Agent Service directly in VS Code. (classic)"
manager: mcleans
