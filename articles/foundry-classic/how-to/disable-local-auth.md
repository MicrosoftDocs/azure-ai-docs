...
> [!NOTE]
> The information in this article is specific to a [!INCLUDE [hub](../includes/hub-project-name.md)] and doesn't apply to an [!INCLUDE [fdp](../../foundry/includes/fdp-project-name.md)]. For more information, see [Types of projects](../what-is-foundry.md#types-of-projects).
