...
<!-- NEW-ONLY: * Foundry model and feature availability [differs by region](../reference/region-support.md). For example, Agent service is [available](../default/agents/concepts/limits-quotas-regions.md) in select regions compared to Azure OpenAI service. -->
