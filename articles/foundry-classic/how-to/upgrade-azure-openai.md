...
* Foundry model and feature availability [differs by region](../reference/region-support.md). For example, Agent service is [available](/azure/foundry/agents/concepts/limits-quotas-regions) in select regions compared to Azure OpenAI service.
