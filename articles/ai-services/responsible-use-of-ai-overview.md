...
## Vision
- [Azure AI Vision - Image Analysis](/azure/ai-foundry/responsible-ai/computer-vision/image-analysis-transparency-note)
- [Azure AI Vision - OCR (legacy)](/azure/ai-foundry/responsible-ai/computer-vision/ocr-transparency-note)
- [Azure AI Vision - Face](/azure/ai-foundry/responsible-ai/face/transparency-note)
...
## Language
- [Azure AI Language](/azure/ai-foundry/responsible-ai/language-service/transparency-note)
- [Azure AI Language - Custom text classification](/azure/ai-foundry/responsible-ai/language-service/custom-text-classification-transparency-note)
- [Azure AI Language - Named entity recognition](/azure/ai-foundry/responsible-ai/language-service/transparency-note-named-entity-recognition)
- [Azure AI Language - Custom named entity recognition](/azure/ai-foundry/responsible-ai/language-service/custom-named-entity-recognition-transparency-note)
- [Azure AI Language - Entity linking](/azure/ai-foundry/responsible-ai/language-service/guidance-integration-responsible-use)
- [Azure AI Language - Language detection](/azure/ai-foundry/responsible-ai/language-service/transparency-note-language-detection)
...
- [Azure AI Speech - Text to speech](/azure/ai-foundry/responsible-ai/speech-service/custom-neural-voice/transparency-note-custom-neural-voice)
