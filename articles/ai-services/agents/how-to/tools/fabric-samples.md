...
description: Learn how to use Microsoft Fabric data agents in Azure AI Agent Service.
...
# How to use the Microsoft Fabric tool in Azure AI Agent Service 

Use this article to find examples and code samples to use the Microsoft Fabric tool in Azure AI Agent Service.
