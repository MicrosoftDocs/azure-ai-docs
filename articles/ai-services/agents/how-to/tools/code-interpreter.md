...
In addition to making files accessible at the Agents level you can pass files so they're only accessible to a particular thread.
...
Files generated by Code Interpreter can be found in the Agent message responses
