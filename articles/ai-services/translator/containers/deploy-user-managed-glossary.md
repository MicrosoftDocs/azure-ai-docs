...
Azure Translator containers allow you to use many of the Translator service's features within your own environment, making them ideal for meeting specific security and data governance needs.
