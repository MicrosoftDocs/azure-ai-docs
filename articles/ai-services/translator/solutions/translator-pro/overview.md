...
* The app is available for download to enterprises that meet certain criteria in selected countries. For more information, *see* [Country/Region availability](#country-availability).
...
* **International availability**. The app is now accessible in selected countries outside of the United States. For more information, *see* [Country/Region availability](#country-availability).
