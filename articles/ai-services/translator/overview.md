...
## Azure Translator features and development options
...
| --- | --- | --- |
| [**Text translation version 2026-06-06 (GA)**](text-translation/overview.md) | &bullet; Azure Translator text translation `2026-06-06` introduces our newest cloud-based, multilingual, neural machine translation service.</br>&bullet; Key enhancements include the option to select specified large language models (LLM), adaptive custom translation, and expanded parameters for translation requests.</br>&bullet; For more information, *see* the [Migration guide](text-translation/how-to/migrate-to-2026-06-06.md). | [**REST API**](text-translation/2026-06-06/rest-api-guide.md) |
