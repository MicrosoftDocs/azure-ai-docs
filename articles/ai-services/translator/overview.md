...
| [**Text translation v3 (GA)**](text-translation/overview.md) | Execute text translation between supported source and target languages in real time. Create a [dynamic dictionary](text-translation/how-to/use-dynamic-dictionary.md) and learn how to [prevent translations](text-translation/how-to/prevent-translation.md) using the Translator API. | &bull; [**REST API**](text-translation/reference/rest-api-guide.md)</br></br>&bull; [**Text translation SDK**](text-translation/sdk-overview.md) </br></br>&bull; [**Translator container**](containers/install-run.md)|
