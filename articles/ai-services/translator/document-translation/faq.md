...
* [Translate text in images within native image files](reference/translate-document.md#translate-text-in-native-image-formats-) as an optional capability with per-image pricing.
