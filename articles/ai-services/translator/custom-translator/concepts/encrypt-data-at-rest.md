...
description: Microsoft lets you manage your Azure AI Foundry Tools subscriptions with your own keys, called customer-managed keys (CMK). This article covers data encryption at rest for Azure Translator in Foundry Tools, and how to enable and manage CMK. 
author: erindormier
manager: nitinme
...
## Azure AI Foundry Tools encryption
...
- [Configure customer-managed keys with Key Vault for Azure AI Foundry Tools encryption from the Azure portal](../../../Encryption/cognitive-services-encryption-keys-portal.md)
...
Only `RSA` keys of size 2048 are supported with Azure AI Foundry Tools encryption. For more information about keys, see **Key Vault keys** in [About Azure Key Vault keys, secrets, and certificates](/azure/key-vault/general/about-keys-secrets-certificates).
