...
1. [**Translate text**](#translate-text). Use the cloud-based, secure, high performance, highly scalable Microsoft Translator [Text API v3](../text-translation/v3/translate.md?tabs=curl) to make translation requests.
...
1. Developers should use the `Category ID` when making translation requests with Microsoft Translator [Text API v3](../text-translation/v3/translate.md?tabs=curl). More information about the Translator Text API can be found on the [API Reference](../text-translation/v3/reference.md) webpage.
