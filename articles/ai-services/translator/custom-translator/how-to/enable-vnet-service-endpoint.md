...
> [!NOTE]
> Before you start, review [how to use virtual networks with Azure AI Foundry Tools](../../../cognitive-services-virtual-networks.md).
...
> * Enabling the `Microsoft.CognitiveServices` endpoint routes all traffic related to Azure AI Foundry Tools through the private global network. Thus, the virtual network should be explicitly allowed to access the resource.
