...
1. [**Translate text**](../../text-translation/v3/translate.md). Use the cloud-based, secure, high performance, highly scalable Azure AI Translator [Text API](../../text-translation/v3/translate.md) to make translation requests.
