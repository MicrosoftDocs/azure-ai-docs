...
> [!NOTE]
> For [best results](/azure/cognitive-services/anomaly-detector/concepts/anomaly-detection-best-practices) when using the Anomaly Detector API, your JSON-formatted time series data should include:
