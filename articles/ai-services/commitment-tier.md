---
title: Use Azure AI Foundry Tools with commitment tier pricing
...
Azure AI offers commitment tier pricing, allowing discounted rates compared to the Standard pricing model. With commitment tier pricing, you can commit to using the following Azure AI Foundry Tools features for a fixed fee, enabling you to have a predictable total cost based on the needs of your workload:
...
* Azure Vision in Foundry Tools - OCR
* Document Intelligence – Custom/Invoice

For more information, see [Azure AI Foundry Tools pricing](https://azure.microsoft.com/pricing/details/cognitive-services/).

> [!NOTE]
> You cannot use commitment tier pricing with an Azure AI Foundry Tools or an Azure AI Foundry multi-service resource. You must use resources dedicated to single services, such as a Speech or Translator resource.

## Create a new resource

1. Sign in to the [Azure portal](https://portal.azure.com) and select **Create a new resource** for one of the applicable Azure AI Foundry Tools or Azure AI Foundry Tools listed.
...
3. Select **Change** to view the available commitments for hosted API and container usage. Choose a commitment plan for one or more of the following offerings:
    ...
    * **Connected container**: Docker containers that enable you to [deploy Azure AI Foundry Tools on premises](cognitive-services-container-support.md), and maintain an internet connection for billing and metering.
