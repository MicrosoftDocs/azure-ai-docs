...
> [!IMPORTANT]
> The steps below explain how to create a resource for use with the [REST API](../quickstart/use-rest-api.md). To use Content Understanding in the Microsoft Foundry portal, see the [AI Foundry quickstart](../quickstart/use-ai-foundry.md).
