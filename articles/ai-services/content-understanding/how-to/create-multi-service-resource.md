...
> [!IMPORTANT]
> The steps below explain how to create a resource for use with the [REST API](../quickstart/use-rest-api.md). To use Content Understanding in the Content Understanding Studio, see the [Content Understanding Studio quickstart](../quickstart/cu-studio.md).
