...
## Overview
Azure AI Content Understanding is an Azure AI Foundry service that transforms unstructured content—documents, images, audio, and video—into structured, searchable data. The Azure AI Foundry experience is complemented by Content Understanding Studio, designed for customers who are transitioning from Azure AI Document Intelligence or need advanced analyzer refinement capabilities. This article describes the capabilities available and planned in each experience.
...
> [!NOTE]
> In AI Foundry Classic, the supported Content Understanding API is 2025-05-01-preview. The updated Foundry NextGen platform will soon support all the new features of the Content Understanding GA API 2025-11-01.
...
* **Azure AI Foundry Classic** supports the preview API, 2025-05-01-preview. It includes some preview features, like Pro mode, that aren't yet available in the GA API. Migrate to the new GA API when possible to continue getting the best experience from Content Understanding.
