...
| **Analyzer template** | A predefined configuration and field schema for an analyzer. It simplifies creating analyzers by allowing modifications to a template instead of starting from scratch. This feature is available only in [Microsoft Foundry portal](https://ai.azure.com/?cid=learnDocs), not via REST API/SDKs. |
