...
description: This guide provides step-by-step instructions to enable diagnostic logging for an Azure AI Foundry Tools. These logs provide rich, frequent data about the operation of a resource that are used for issue identification and debugging.
...
# Enable diagnostic logging for Azure AI Foundry Tools

This guide provides step-by-step instructions to enable diagnostic logging for an Azure AI Foundry Tools. These logs provide rich, frequent data about the operation of a resource that are used for issue identification and debugging. Before you continue, you must have an Azure account with a subscription to at least one Azure AI Foundry Tools, such as [Azure Speech](./speech-service/overview.md).
