...
| --- | --- | --- |
| ![Azure AI model inference icon](~/reusable-content/ce-skilling/azure/media/ai-services/azure-openai.svg) [Azure AI model inference](./openai/index.yml) | Performs model inference for flagship models in the Azure AI model catalog. | `AIServices` |
