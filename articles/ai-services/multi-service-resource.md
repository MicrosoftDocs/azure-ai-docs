...
Looking to use [Azure Search skills?](../search/tutorial-skillset.md) See [Use Azure AI Foundry with Azure Search skills](multi-services-resource-search-skills.md).
