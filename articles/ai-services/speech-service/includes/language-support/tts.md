...
| Locale (BCP-47) | Language | Type | Text to speech voices | Style/Roles |
| ----- | ----- | ----- | ----- | ----- |
...
| `en-GB` | English (United Kingdom) | Standard | `en-GB-Ryan:DragonHDLatestNeural`<sup>1</sup> (Male) |  |
| `en-GB` | English (United Kingdom) | Standard | `en-GB-Sonia:DragonHDLatestNeural`<sup>1</sup> (Female) |  |
...
| `en-IN` | English (India) | Neural HD | `en-IN-Meera:DragonHDLatestNeural`<sup>1</sup> (Female) |  |
| `en-IN` | English (India) | Neural HD | `en-IN-Aarti:DragonHDLatestNeural`<sup>1</sup> (Female) |  |
| `en-IN` | English (India) | Neural HD | `en-IN-Arjun:DragonHDLatestNeural`<sup>1</sup> (Male) |  |
...
| `en-US` | English (United States) | Standard | `en-US-AIGenerate1Neural`<sup>1</sup> (Male) |  |
...
| `es-MX` | Spanish (Mexico) | Neural HD | `es-MX-Ximena:DragonHDLatestNeural` (Female) |  |
...
| `fr-CA` | French (Canada) | Neural HD | `fr-CA-Thierry:DragonHDLatestNeural` (Male) |  |
...
| `it-IT` | Italian (Italy) | Neural HD | `it-IT-Alessio:DragonHDLatestNeural` (Male) |  |
...
| `ko-KR` | Korean (Korea) | Neural HD | `ko-KR-SunHi:DragonHDLatestNeural` (Female) |  |
