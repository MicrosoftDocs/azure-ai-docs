...
| `en-IN` | English (India) | `en-IN-AartiIndicNeural` (Female)<br/>`en-IN-ArjunIndicNeural` (Male)<br/>`en-IN-NeerjaIndicNeural` (Female)<br/>`en-IN-PrabhatIndicNeural` (Male)<br/>`en-IN-AaravNeural` (Male)<br/>`en-IN-AashiNeural` (Female)<br/>`en-IN-AartiNeural` (Female)<br/>`en-IN-ArjunNeural` (Male)<br/>`en-IN-AnanyaNeural` (Female)<br/>`en-IN-KavyaNeural` (Female)<br/>`en-IN-KunalNeural` (Male)<br/>`en-IN-NeerjaNeural` (Female)<br/>`en-IN-PrabhatNeural` (Male)<br/>`en-IN-RehaanNeural` (Male) |
