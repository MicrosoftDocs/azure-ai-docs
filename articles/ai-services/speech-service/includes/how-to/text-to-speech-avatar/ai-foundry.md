...
1. For custom avatar or custom video authoring workflows, use **Build** > **Fine-tune** in the same Foundry project. Those authoring options are available for approved customers.
