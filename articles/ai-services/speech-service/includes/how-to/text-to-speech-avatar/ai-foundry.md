...
1. The **Foundry Tools** tab shows the Azure AI models that can be used out of the box in the Foundry portal. Select **Azure Speech - Text to Speech Avatar** to open the Text to Speech Avatar playground.
1. Choose a prebuilt avatar from the grid, and select a voice from the **Voice** dropdown menu.
1. Enter your sample text in the text box on the right.
