...
:::image type="content" source="../../../../media/custom-voice/professional-voice/cnv-endpoint-test.png" alt-text="Screenshot of test an endpoint." lightbox="../../../../media/custom-voice/professional-voice/cnv-endpoint-test":::
