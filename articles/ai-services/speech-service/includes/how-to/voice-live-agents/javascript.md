...
:::code language="javascript" source="~/voice-live-samples-code/javascript/voice-live-quickstarts/AgentsNewQuickstart/voice-live-with-agent-v2.js" range="135-163,356-397" highlight="9,22,39,59":::
...
:::code language="javascript" source="~/voice-live-samples-code/javascript/voice-live-quickstarts/AgentsNewQuickstart/voice-live-with-agent-v2.js" range="135-163,356-397" highlight="11-14,25-28,43-44,61-62":::
...
:::code language="javascript" source="~/voice-live-samples-code/javascript/voice-live-quickstarts/AgentsNewQuickstart/voice-live-with-agent-v2.js" range="206-222" highlight="2-17":::
...
:::code language="javascript" source="~/voice-live-samples-code/javascript/voice-live-quickstarts/AgentsNewQuickstart/voice-live-with-agent-v2.js" range="334-350" highlight="3-16":::
...
:::code language="javascript" source="~/voice-live-samples-code/javascript/voice-live-quickstarts/AgentsNewQuickstart/voice-live-with-agent-v2.js" range="186-201":::
...
:::code language="javascript" source="~/voice-live-samples-code/javascript/voice-live-quickstarts/AgentsNewQuickstart/voice-live-with-agent-v2.js" range="361,393-394":::
...
:::code language="javascript" source="~/voice-live-samples-code/javascript/voice-live-quickstarts/AgentsNewQuickstart/voice-live-with-agent-v2.js" range="21-33,186-201" highlight="1-2,9,14-15":::
