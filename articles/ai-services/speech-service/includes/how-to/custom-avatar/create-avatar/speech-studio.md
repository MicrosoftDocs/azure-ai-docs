...
> [!NOTE]
> Custom avatar access (including custom photo avatar) is limited based on eligibility and usage criteria. Request access on the [intake form](https://aka.ms/customneural).
