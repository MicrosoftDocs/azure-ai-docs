...
- `azure-ai-voicelive` package version 1.2.0 or later (MCP support requires `api_version="2026-04-15"`).
...
MCP support requires `api_version="2026-04-15"` or later. Pass this value in the `connect()` call.
