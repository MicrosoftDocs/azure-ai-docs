...
:::code language="java" source="~/voice-live-samples-code/java/voice-live-quickstarts/MCPQuickstart/src/main/java/MCPQuickstart.java" id="define_mcp_servers":::
...
:::code language="java" source="~/voice-live-samples-code/java/voice-live-quickstarts/MCPQuickstart/src/main/java/MCPQuickstart.java" id="configure_session":::
...
:::code language="java" source="~/voice-live-samples-code/java/voice-live-quickstarts/MCPQuickstart/src/main/java/MCPQuickstart.java" id="handle_mcp_events":::
...
:::code language="java" source="~/voice-live-samples-code/java/voice-live-quickstarts/MCPQuickstart/src/main/java/MCPQuickstart.java" id="handle_approval":::
...
:::code language="java" source="~/voice-live-samples-code/java/voice-live-quickstarts/MCPQuickstart/src/main/java/MCPQuickstart.java" id="voice_approval_transcription":::
...
:::code language="java" source="~/voice-live-samples-code/java/voice-live-quickstarts/MCPQuickstart/src/main/java/MCPQuickstart.java" id="mcp_stall_detection":::
...
1. Create the **src/main/java/MCPQuickstart.java** file with the following code:
    ...
    :::code language="java" source="~/voice-live-samples-code/java/voice-live-quickstarts/MCPQuickstart/src/main/java/MCPQuickstart.java":::
