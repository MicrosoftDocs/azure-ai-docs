...
* Speech services are not available in three new regions: *Canada East*, *Italy North* and *UK West*. For more information, see [Speech service supported regions](./regions.md).
