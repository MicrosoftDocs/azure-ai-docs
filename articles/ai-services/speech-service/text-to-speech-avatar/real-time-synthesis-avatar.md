...
- **AI Foundry resources:** [Creat Azure AI Foundry resource](https://review.learn.microsoft.com/en-us/azure/ai-services/multi-service-resource)created in one of the supported regions. For more information about region availability, see the [Text to speech avatar regions](../regions.md#tab/ttsavatar).
