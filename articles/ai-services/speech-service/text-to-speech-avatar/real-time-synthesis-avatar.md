...
- **AI Foundry resources:** [Creat Azure AI Foundry resource](https://learn.microsoft.com/azure/ai-services/multi-service-resource?pivots=azportal)created in one of the supported regions. For more information about region availability, see the [Text to speech avatar regions](../regions.md).
