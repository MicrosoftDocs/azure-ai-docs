...
If you create a custom photo avatar from a real person's photo, you must get consent from that person. Provide a video of the person reading a consent statement that acknowledges the use of their image, including about one minute of audio. Microsoft verifies that the recorded statement matches the predefined script, compares the face in the video with the photo to confirm they belong to the same person, and uses the consent audio to help match the voice to the avatar.
