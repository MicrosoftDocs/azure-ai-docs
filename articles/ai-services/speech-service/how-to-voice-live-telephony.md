...
description: Learn how to set up and use telephony integration with the Voice live API for real-time voice agents.
...
The Github readme provides instructions on how to: 
- Quickly deploy the solution template using the Azure Developer CLI 
- Test the voice agent using either a Web Client or a phone call using ACS

See [Call Center Voice Agent Accelerator with Azure Voice Live API](https://github.com/Azure-Samples/call-center-voice-agent-accelerator) for details. 
