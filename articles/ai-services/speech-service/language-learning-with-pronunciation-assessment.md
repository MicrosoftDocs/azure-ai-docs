...
> [!NOTE]
> The language learning feature currently supports only `en-US`. For available regions, see [available regions for pronunciation assessment](regions.md#regions). If you turn on the **Avatar** button to interact with a text to speech avatar, see the available [regions](regions.md?tabs=ttsavatar) for text to speech avatar. 
>
