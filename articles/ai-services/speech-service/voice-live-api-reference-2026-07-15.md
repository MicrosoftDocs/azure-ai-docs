...
| Field | Type | Description |
| --- | --- | --- |
| model | string | The transcription model.<br>Supported with `gpt-realtime` and `gpt-realtime-mini`:<br>`whisper-1`, `gpt-4o-transcribe`, `gpt-4o-mini-transcribe`, `gpt-4o-transcribe-diarize`, `mai-transcribe`, `mai-transcribe-2`.<br>Supported with **all other models** and **agents**: `azure-speech`, `mai-transcribe`, and `mai-transcribe-2` |
...
| phrase\_list | string[] | Optional list of phrase hints to bias recognition. Supported with `azure-speech`, `mai-transcribe`, and `mai-transcribe-2`. |
...
| results | array of [FileSearchResult](#filesearchresult) | Optional. The results of the file search. |
