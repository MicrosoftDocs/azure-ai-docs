...
* Azure Document Intelligence / Form Recognizer is a cloud-based Azure AI Foundry Tools service that uses machine learning to extract key-value pairs, text, tables, and key data from your documents.
