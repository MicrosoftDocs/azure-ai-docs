...
Azure Document Intelligence in Foundry Tools is a cloud-based [Azure AI Foundry Tools](../../../ai-services/index.yml) that uses machine-learning models to extract key/value pairs, text, and tables from your documents. In this article, learn how to create a Document Intelligence resource in the Azure portal.
