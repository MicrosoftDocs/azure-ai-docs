...
* **When you have static information** - Use QnA Maker when you have static information in your knowledge base of answers. This knowledge base is custom to your needs, which you built with documents such as [PDFs and URLs](../concepts/data-sources-and-content.md).
