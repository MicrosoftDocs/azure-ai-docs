...
To import an existing Azure AI services project with Foundry, you need to create a connection to the Azure AI services resource within your Foundry project. For more information, *see* [Connect Foundry Tools projects to Foundry](../../../../ai-services/connect-services-ai-foundry-portal.md)
