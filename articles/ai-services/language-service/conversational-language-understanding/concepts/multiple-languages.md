...
Whenever you identify that a particular language isn't performing as well as other languages, you can add utterances for that language in your project. In the [tag utterances](../how-to/build-train-deploy-model.md#label-your-utterances) page in Microsoft Foundry, you can select the language of the utterance you're adding. When you introduce examples for that language to the model, it's introduced to more of the syntax of that language and learns to predict it better.
...
* [Tag utterances](../how-to/build-train-deploy-model.md#label-your-utterances) 
