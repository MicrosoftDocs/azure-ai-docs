...
1. In your storage account, select **Containers** from the left menu, located below **Data storage**. On the screen that appears, select **+ Container**. Give the container the name **example-data** and leave the default **Public access level**.
    ...
    :::image type="content" source="../../../media/custom/foundry/storage-screen.png" alt-text="A screenshot showing the main page for a storage account." lightbox="../../../media/custom/foundry/storage-screen.png":::
...
1. After your container is created, select it. Then select **Upload** button to select the `.txt` and `.json` files you downloaded earlier.
    ...
    :::image type="content" source="../../../media/custom/foundry/file-upload-screen.png" alt-text="A screenshot showing the button for uploading files to the storage account." lightbox="../../../media/custom/foundry/file-upload-screen.png":::
