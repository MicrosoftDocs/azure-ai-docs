...
|[**REST API or Client library (Azure SDK)**](/rest/api/language/analyze-text/analyze-text/analyze-text)| Integrate language detection into your applications using the REST API, or the client library available in a variety of languages.|
