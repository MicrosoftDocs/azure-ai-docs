...
|`{API-VERSION}`     | The version of the API you're calling. The value referenced is for the latest [model version](../../../../concepts/model-lifecycle.md#choose-the-model-version-used-on-your-data) released. | `2023-04-15-preview` |
