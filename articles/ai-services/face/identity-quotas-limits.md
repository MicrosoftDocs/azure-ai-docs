...
> [!NOTE]
> If you exceed the default rate limit, you receive a `429` error. To address this issue, refer to the [Performance guide](./how-to/mitigate-latency.md#handle-errors-effectively).
