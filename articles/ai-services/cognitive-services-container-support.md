...
| [Speech API][sp-containers-ft] | **Fast transcription** ([image](https://mcr.microsoft.com/product/azure-cognitive-services/speechservices/fast-transcription/about)) | Transcribes complete audio files synchronously and faster than real-time. Supports speaker diarization and multichannel audio processing. | Public preview. <br> This container can also [run in disconnected environments](containers/disconnected-containers.md). |
