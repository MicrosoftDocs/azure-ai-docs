...
|--|--|--|--|
|Analyze text | **Text Analyze** ([image](https://mcr.microsoft.com/en-us/artifact/mar/azure-cognitive-services/contentsafety/text-analyze/about)) | Detects and mitigates text content generated by both foundation models and humans. | Preview. This container can also [run in disconnected environments](/azure/ai-services/containers/disconnected-containers). |
|Analyze image | **Image Analyze** ([image](https://mcr.microsoft.com/en-us/artifact/mar/azure-cognitive-services/contentsafety/image-analyze/about)) | Detects and mitigates image content generated by both foundation models and humans. | Preview.<br> This container can also [run in disconnected environments](/azure/ai-services/containers/disconnected-containers). |
|Prompt Shields for user prompts and documents  |**Prompt Shields** ([image](https://mcr.microsoft.com/en-us/artifact/mar/azure-cognitive-services/contentsafety/promptshields/about)) |Detects and mitigates user prompt attacks and safeguards against attacks not directly supplied by the user or developer, such as external documents. |Preview.<br> This container can also [run in disconnected environments](/azure/ai-services/containers/disconnected-containers). |
...
| [Language][ta-containers-summarization] | **Summarization** ([image](https://mcr.microsoft.com/product/azure-cognitive-services/textanalytics/summarization/about))| Summarize text from various sources. | Preview. <br>This container can also [run in disconnected environments](containers/disconnected-containers.md). |
...
| [Speech API][sp-containers-ft] | **Fast transcription** ([image](https://mcr.microsoft.com/product/azure-cognitive-services/speechservices/fast-transcription/about)) | Transcribes complete audio files synchronously and faster than real-time. Supports speaker diarization and multichannel audio processing. | Preview. <br> This container can also [run in disconnected environments](containers/disconnected-containers.md). |
