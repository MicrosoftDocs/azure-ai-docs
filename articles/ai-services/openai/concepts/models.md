...
|  --- |  :--- |:--- |:---: |
| `o1` (2024-12-17) | The most capable model in the o1 series, offering enhanced reasoning abilities. <br> - Structured outputs<br> - Text, image processing <br> - Functions/Tools <br> <br> **Request access: [limited access model application](https://aka.ms/OAI/o1access)** | Input: 200,000 <br> Output: 100,000 | Oct 2023 |  
