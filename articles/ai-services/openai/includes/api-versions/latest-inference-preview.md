...
| logprobs | integer | Include the log probabilities on the `logprobs` most likely output tokens, as well the chosen tokens. For example, if `logprobs` is 5, the API will return a list of the 5 most likely tokens. The API will always return the `logprob` of the sampled token, so there might be up to `logprobs+1` elements in the response.<br><br>The maximum value for `logprobs` is 5.<br> | No | None |
...
```HTTP
POST https://{endpoint}/openai/deployments/{deployment-id}/embeddings?api-version=2024-08-01-preview
```
...
| functions | array | Deprecated in favor of `tools`.<br><br>A list of functions the model might generate JSON inputs for.<br> | No |  |
...
```HTTP
POST https://{endpoint}/openai/deployments/{deployment-id}/audio/transcriptions?api-version=2024-08-01-preview
```
...
```HTTP
POST https://{endpoint}/openai/deployments/{deployment-id}/audio/translations?api-version=2024-08-01-preview
```
...
```HTTP
POST https://{endpoint}/openai/deployments/{deployment-id}/audio/speech?api-version=2024-08-01-preview
```
...
```HTTP
POST https://{endpoint}/openai/deployments/{deployment-id}/images/generations?api-version=2024-08-01-preview
```
...
```HTTP
GET https://{endpoint}/openai/assistants?api-version=2024-08-01-preview
```
...
```HTTP
POST https://{endpoint}/openai/assistants?api-version=2024-08-01-preview
```
...
```HTTP
GET https://{endpoint}/openai/assistants/{assistant_id}?api-version=2024-08-01-preview
```
...
```HTTP
POST https://{endpoint}/openai/assistants/{assistant_id}?api-version=2024-08-01-preview
```
...
```HTTP
DELETE https://{endpoint}/openai/assistants/{assistant_id}?api-version=2024-08-01-preview
```
...
```HTTP
GET https://{endpoint}/openai/threads/{thread_id}?api-version=2024-08-01-preview
```
...
```HTTP
POST https://{endpoint}/openai/threads/{thread_id}?api-version=2024-08-01-preview
```
...
```HTTP
DELETE https://{endpoint}/openai/threads/{thread_id}?api-version=2024-08-01-preview
```
...
```HTTP
GET https://{endpoint}/openai/threads/{thread_id}/messages?api-version=2024-08-01-preview
```
...
```HTTP
POST https://{endpoint}/openai/threads/{thread_id}/messages?api-version=2024-08-01-preview
```
...
```HTTP
GET https://{endpoint}/openai/threads/{thread_id}/messages/{message_id}?api-version=2024-08-01-preview
```
...
```HTTP
POST https://{endpoint}/openai/threads/{thread_id}/messages/{message_id}?api-version=2024-08-01-preview
```
...
| model | string | The deployment name of the model to be used to execute this run. If a value is provided here, it will override the model associated with the assistant. If not, the model associated with the assistant will be used. | No |  |
...
```HTTP
GET https://{endpoint}/openai/threads/{thread_id}/runs?api-version=2024-08-01-preview
```
...
```HTTP
POST https://{endpoint}/openai/threads/{thread_id}/runs?api-version=2024-08-01-preview
```
...
```HTTP
GET https://{endpoint}/openai/threads/{thread_id}/runs/{run_id}?api-version=2024-08-01-preview
```
...
```HTTP
POST https://{endpoint}/openai/threads/{thread_id}/runs/{run_id}?api-version=2024-08-01-preview
```
...
```HTTP
POST https://{endpoint}/openai/threads/{thread_id}/runs/{run_id}/submit_tool_outputs?api-version=2024-08-01-preview
```
...
```HTTP
POST https://{endpoint}/openai/threads/{thread_id}/runs/{run_id}/cancel?api-version=2024-08-01-preview
```
...
```HTTP
GET https://{endpoint}/openai/threads/{thread_id}/runs/{run_id}/steps?api-version=2024-08-01-preview
```
...
```HTTP
GET https://{endpoint}/openai/threads/{thread_id}/runs/{run_id}/steps/{step_id}?api-version=2024-08-01-preview
```
...
```HTTP
GET https://{endpoint}/openai/vector_stores?api-version=2024-08-01-preview
```
...
```HTTP
POST https://{endpoint}/openai/vector_stores?api-version=2024-08-01-preview
```
...
```HTTP
GET https://{endpoint}/openai/vector_stores/{vector_store_id}?api-version=2024-08-01-preview
```
...
```HTTP
POST https://{endpoint}/openai/vector_stores/{vector_store_id}?api-version=2024-08-01-preview
```
...
```HTTP
DELETE https://{endpoint}/openai/vector_stores/{vector_store_id}?api-version=2024-08-01-preview
```
...
```HTTP
GET https://{endpoint}/openai/vector_stores/{vector_store_id}/files?api-version=2024-08-01-preview
```
...
```HTTP
POST https://{endpoint}/openai/vector_stores/{vector_store_id}/files?api-version=2024-08-01-preview
```
...
```HTTP
GET https://{endpoint}/openai/vector_stores/{vector_store_id}/files/{file_id}?api-version=2024-08-01-preview
```
...
```HTTP
DELETE https://{endpoint}/openai/vector_stores/{vector_store_id}/files/{file_id}?api-version=2024-08-01-preview
```
...
```HTTP
POST https://{endpoint}/openai/vector_stores/{vector_store_id}/file_batches?api-version=2024-08-01-preview
```
...
```HTTP
GET https://{endpoint}/openai/vector_stores/{vector_store_id}/file_batches/{batch_id}?api-version=2024-08-01-preview
```
...
```HTTP
POST https://{endpoint}/openai/vector_stores/{vector_store_id}/file_batches/{batch_id}/cancel?api-version=2024-08-01-preview
```
...
```HTTP
GET https://{endpoint}/openai/vector_stores/{vector_store_id}/file_batches/{batch_id}/files?api-version=2024-08-01-preview
```
...
The details of a vectorization source, used by Azure OpenAI On Your Data when applying vector search, that is based on an Azure OpenAI endpoint call for embeddings.
...
|------|------|-------------|----------|---------|
| event | string |  | Yes |  |
| data | [threadObject](#threadobject) | Represents a thread that contains messages. |
