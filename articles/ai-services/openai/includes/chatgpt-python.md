...
* [Get started with the chat using your own data sample for Python](/azure/developer/python/get-started-app-chat-template??context=/azure/ai-services/openai/context/context&tabs=github-codespaces)
