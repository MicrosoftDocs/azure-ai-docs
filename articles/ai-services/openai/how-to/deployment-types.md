...
> [!NOTE]
> Deployment types do not provide high availability to your Azure OpenAI resource. Even with global and data zone deployment types if the primary region experiences an interruption in service all traffic that is initially routed to this region will be impacted. To learn more, consult the [business continuity and disaster recovery guide](../how-to/business-continuity-disaster-recovery.md).
