...
> [!TIP]
> Some regions now support a new fail fast behavior which better allows for [**automating retries of large batch jobs with exponential backoff**](../includes/batch/batch-python.md#queueing-batch-jobs).
