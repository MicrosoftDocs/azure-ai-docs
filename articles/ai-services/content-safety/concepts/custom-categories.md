...
> [!IMPORTANT]
> Custom categories (standard) is retiring on September 1, 2026. Migrate to the [Custom text API in Foundry Custom text classification - Foundry Tools | Microsoft Learn](/azure/ai-services/language-service/custom-text-classification/overview.md).
