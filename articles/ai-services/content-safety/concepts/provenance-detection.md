...
description: Learn what the Azure AI Content Safety Provenance Detect API does, what signals it can detect, common use cases, and current limitations.
author: ssalgadodev
manager: nitinme
...
## How the Provenance Detect API works
...
The API should not be used as a standalone determination of authenticity or trustworthiness. The following are limiations: 
...
The API supports media content under 100MB. These include image files (JPEG, PNG, GIF, WebP), audio files (MP3, WAV, M4A/MPF-audio), and video files (MP4).
...
The [Content Provenance Detection](https://aka.ms/ProvenanceValidationSite) checks whether media content contains provenance or invisible watermarking signals that indicate it was generated by Microsoft AI systems. The API provides the tool's capabilities.
...
- [Content Provenance Detection Reference](../how-to/how-to-provenance-detection.md)
