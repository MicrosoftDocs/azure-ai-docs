...
The fully qualified container image name is, `mcr.microsoft.com/azure-cognitive-services/contentsafety/text-analyze`. Either append a specific version or append `:latest` to get the most recent version.
...
* See the [content safety containers overview](./aacs-container-overview.md)
