...
Get started applying basic text moderation with the Content Safety Studio, REST API, or client libraries. The Azure AI Content Safety service provides you with AI algorithms for flagging objectionable content. Follow these steps to try it out.
