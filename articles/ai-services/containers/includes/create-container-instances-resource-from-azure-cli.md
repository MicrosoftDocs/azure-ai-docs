...
> [!TIP]
> Pay close attention to the locations of Microsoft Foundry Tools in public preview, as the YAML will needed to be adjusted accordingly to match the location.
