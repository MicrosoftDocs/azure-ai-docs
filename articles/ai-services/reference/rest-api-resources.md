...
| ![Content Safety icon](~/reusable-content/ce-skilling/azure/media/ai-services/content-safety.svg) [Content Safety](../content-safety/index.yml) | An AI service that detects unwanted contents | [Content Safety API](/rest/api/contentsafety/operation-groups?view=rest-contentsafety-2024-09-01) |
...
| ![Vision icon](~/reusable-content/ce-skilling/azure/media/ai-services/vision.svg) [Vision](../computer-vision/index.yml) | Analyze content in images and videos | [Vision API](/rest/api/computervision/operation-groups?view=rest-computervision-v4.0-preview%20(2023-02-01)) |
