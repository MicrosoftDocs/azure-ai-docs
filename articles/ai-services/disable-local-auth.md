---
title: Disable local authentication in Azure AI Foundry Tools
titleSuffix: Azure AI Foundry Tools
description: "This article describes how to disable local authentication in Azure AI Foundry Tools for improved security."
...
# Disable local authentication in Azure AI Foundry Tools

Azure AI Foundry Tools provides Microsoft Entra authentication support for all resources. This feature provides you with seamless integration when you require centralized control and management of identities and resource credentials. Organizations can disable local authentication methods and enforce Microsoft Entra authentication instead.

## How to disable local authentication

You can disable local authentication using the Azure policy **Azure AI Foundry Tools resources should have key access disabled (disable local authentication)**. Set it at the subscription level or resource group level to enforce the policy for a group of services.
