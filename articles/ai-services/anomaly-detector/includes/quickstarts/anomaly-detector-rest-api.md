...
* A valid JSON file of time series data to test for anomalies. If you don't have your own file, you can create a sample.json file from the [Azure AI Foundry REST API reference](/rest/api/microsoft-foundry/).
...
For more information, see the [Azure AI Foundry REST API reference](/rest/api/microsoft-foundry/).
