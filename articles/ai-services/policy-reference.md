---
title: Built-in policy definitions for Azure AI Foundry Tools
description: Lists Azure Policy built-in policy definitions for Azure AI Foundry Tools. These built-in policy definitions provide common approaches to managing your Azure resources.
ms.date: 10/02/2025
author: nitinme
ms.author: nitinme
...
---
# Azure Policy built-in policy definitions for Azure AI Foundry Tools

This page is an index of [Azure Policy](/azure/governance/policy/overview) built-in policy
definitions for Azure AI Foundry Tools. For additional Azure Policy built-ins for other services,
