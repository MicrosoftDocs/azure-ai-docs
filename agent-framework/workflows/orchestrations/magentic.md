...
> [!TIP]
> A standard manager is based on the Magentic-One design, with fixed prompts taken from the original paper. Customize the manager's behavior by passing prompts to `MagenticBuilder`.
>
