...
Go agents support background responses through the `agent.AllowBackgroundResponses` option. This enables the agent to produce asynchronous responses that can be retrieved later.
